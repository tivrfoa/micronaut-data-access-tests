   ...
   public void start() {
      ...
      if (this.fileNamePatternStr != null) {
         ...
         throw new IllegalStateException(
            "The \"FileNamePattern\" property must be set before using FixedWindowRollingPolicy. See also http://logback.qos.ch/codes.html#tbr_fnp_not_set"
         );
      }
   }
   ...
   public void rollover() throws RolloverFailure {
      if (this.maxIndex >= 0) {
         ...
         switch(this.compressionMode) {
            ...
            case ZIP:
               this.compressor
                  .compress(this.getActiveFileName(), this.fileNamePattern.convertInt(this.minIndex), this.zipEntryFileNamePattern.convert(new Date()));
         }
      }
