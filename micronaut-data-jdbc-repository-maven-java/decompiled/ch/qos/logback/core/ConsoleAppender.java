...
public class ConsoleAppender<E> extends OutputStreamAppender<E> {
   ...
   private OutputStream getTargetStreamForWindows(OutputStream targetStream) {
      try {
         ...
         Object windowsAnsiOutputStream = OptionHelper.instantiateByClassNameAndParameter(
            "org.fusesource.jansi.WindowsAnsiOutputStream", Object.class, this.context, OutputStream.class, targetStream
         );
