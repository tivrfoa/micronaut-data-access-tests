...
public class Node {
   ...
   public Node(Node.Type type, Object payload) {
      this.type = type;
      this.payload = payload;
   }

   public Node(Node.Type type, Object payload, Object defaultPart) {
      this.type = type;
      this.payload = payload;
   ...
   public int hashCode() {
      ...
      return 31 * result + (this.next != null ? this.next.hashCode() : 0);
   }
