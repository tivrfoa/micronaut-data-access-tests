...
public class PropertySetter extends ContextAwareBase {
   ...
   void invokeMethodWithSingleParameterOnThisObject(Method method, Object parameter) {
      ...
      try {
         ...
         this.addError(
            "Could not invoke method " + method.getName() + " in class " + this.obj.getClass().getName() + " with parameter of type " + ccc.getName(), var5
         );
      }
   ...
   <T extends Annotation> T getAnnotation(String name, Class<T> annonationClass, Method relevantMethod) {
      return (T)(relevantMethod != null ? relevantMethod.getAnnotation(annonationClass) : null);
   }
