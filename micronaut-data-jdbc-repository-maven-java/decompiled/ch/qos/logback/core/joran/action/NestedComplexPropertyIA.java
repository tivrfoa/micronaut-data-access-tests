   ...
   public void begin(InterpretationContext ec, String localName, Attributes attributes) {
      ...
      try {
         if (!OptionHelper.isEmpty(className)) {
            ...
            componentClass = parentBean.getClassNameViaImplicitRules(
               actionData.getComplexPropertyName(), actionData.getAggregationType(), ec.getDefaultNestedComponentRegistry()
            );
         }
