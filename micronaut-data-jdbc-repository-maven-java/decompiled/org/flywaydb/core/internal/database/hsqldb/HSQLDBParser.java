...
public class HSQLDBParser extends Parser {
   ...
   protected int getLastKeywordIndex(List<Token> tokens, int endIndex) {
      for(int i = endIndex - 1; i >= 0; --i) {
         ...
         if (tokenText != null && this.getValidKeywords().contains(tokenText.toUpperCase(Locale.ENGLISH))) {
            return i;
         }
      }
   ...
   protected boolean shouldAdjustBlockDepth(ParserContext context, List<Token> tokens, Token token) {
      ...
      return tokenText != null && this.getValidKeywords().contains(tokenText.toUpperCase(Locale.ENGLISH)) && token.getParensDepth() == 0
         ? true
   ...
   protected void adjustBlockDepth(ParserContext context, List<Token> tokens, Token keyword, PeekingReader reader) throws IOException {
      ...
      Token previousKeyword = lastKeywordIndex >= 0 ? (Token)tokens.get(lastKeywordIndex) : null;
      ...
      if (!"BEGIN".equalsIgnoreCase(keywordText)
         ...
         if (("EACH".equalsIgnoreCase(keywordText) || "SQLEXCEPTION".equalsIgnoreCase(keywordText))
            && previousKeyword != null
