...
public class ArrayUtils {
   ...
   public static <E> List<E> toUnmodifiableList(E[] elements) {
      return (List<E>)(elements.length == 0 ? Collections.emptyList() : new ArrayUtils.UnmodifiableArrayList<E>(elements));
   }
   ...
   public static <E> List<E> toUnmodifiableCompositeList(E[] array1, E[] array2) {
      ...
      if (array1.length == 0) {
         ...
         result = new ArrayUtils.CompositeUnmodifiableArrayList<E>(array1, array2);
      }
