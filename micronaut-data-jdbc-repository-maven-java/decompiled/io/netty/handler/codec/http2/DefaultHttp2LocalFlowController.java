         ...
         new Http2ConnectionAdapter() {
            ...
            public void onStreamClosed(Http2Stream stream) {
               try {
                  ...
                  if (DefaultHttp2LocalFlowController.this.ctx != null
                     && unconsumedBytes > 0
   ...
   private class DefaultState implements DefaultHttp2LocalFlowController.FlowState {
      ...
      private void writeWindowUpdate() throws Http2Exception {
         ...
         DefaultHttp2LocalFlowController.this.frameWriter
            .writeWindowUpdate(
               DefaultHttp2LocalFlowController.this.ctx, this.stream.id(), deltaWindowSize, DefaultHttp2LocalFlowController.this.ctx.newPromise()
            );
      }
   }
