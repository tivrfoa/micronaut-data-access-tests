...
final class HpackHuffmanDecoder implements ByteProcessor {
   ...
   private static final Http2Exception BAD_ENCODING = Http2Exception.newStatic(
      Http2Error.COMPRESSION_ERROR, "HPACK - Bad Encoding", Http2Exception.ShutdownHint.HARD_SHUTDOWN, HpackHuffmanDecoder.class, "decode(..)"
   );
   private byte[] dest;
   private int k;
   private int state;
   ...
   public AsciiString decode(ByteBuf buf, int length) throws Http2Exception {
      if (length == 0) {
         ...
         try {
            ...
            var5 = new AsciiString(this.dest, 0, this.k, false);
         } finally {
            this.dest = null;
            this.k = 0;
            this.state = 0;
