   ...
   public void delete() {
      if (this.fileChannel != null) {
         try {
            ...
            logger.warn("Failed to force.", var10);
         } finally {
            try {
               this.fileChannel.close();
            } catch (IOException var9) {
               logger.warn("Failed to close a file.", var9);
            }
            ...
            if (inputAccessFile != null) {
               try {
                  ...
                  if (exception == null) {
                     ...
                     logger.warn("Multiple exceptions detected, the following will be suppressed {}", var22);
                  }
               }
            }
            ...
            if (outputAccessFile != null) {
               try {
                  ...
                  if (exception == null) {
                     ...
                     logger.warn("Multiple exceptions detected, the following will be suppressed {}", var21);
                  }
               }
            }
