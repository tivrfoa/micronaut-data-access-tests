...
public class SpdyProtocolException extends Exception {
   ...
   static SpdyProtocolException newStatic(String message, Class<?> clazz, String method) {
      ...
      if (PlatformDependent.javaVersion() >= 7) {
         exception = new SpdyProtocolException.StacklessSpdyProtocolException(message, true);
      } else {
         exception = new SpdyProtocolException.StacklessSpdyProtocolException(message);
      }
