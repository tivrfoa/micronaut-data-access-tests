...
class OpenSslSessionCache implements SSLSessionCache {
   ...
   private void expungeInvalidSessions() {
      if (!this.sessions.isEmpty()) {
         ...
         while(iterator.hasNext()) {
            OpenSslSessionCache.NativeSslSession session = (OpenSslSessionCache.NativeSslSession)((Entry)iterator.next()).getValue();
   ...
   public final boolean sessionCreated(long ssl, long sslSession) {
      ...
      if (engine == null) {
         ...
         OpenSslSessionCache.NativeSslSession session = new OpenSslSessionCache.NativeSslSession(
            sslSession, engine.getPeerHost(), engine.getPeerPort(), (long)this.getSessionTimeout() * 1000L
         );
         ...
         synchronized(this) {
            ...
            if (!this.sessionCreated(session)) {
               ...
               OpenSslSessionCache.NativeSslSession old = (OpenSslSessionCache.NativeSslSession)this.sessions.put(session.sessionId(), session);
               if (old != null) {
   ...
   public final long getSession(long ssl, byte[] sessionId) {
      ...
      synchronized(this) {
         session = (OpenSslSessionCache.NativeSslSession)this.sessions.get(id);
         if (session == null) {
            return -1L;
         }
   ...
   final synchronized void removeSessionWithId(OpenSslSessionId id) {
      OpenSslSessionCache.NativeSslSession sslSession = (OpenSslSessionCache.NativeSslSession)this.sessions.remove(id);
      if (sslSession != null) {
   ...
   final synchronized OpenSslSession getSession(OpenSslSessionId id) {
      OpenSslSessionCache.NativeSslSession session = (OpenSslSessionCache.NativeSslSession)this.sessions.get(id);
   ...
   static final class NativeSslSession implements OpenSslSession {
      ...
      public boolean equals(Object o) {
         if (this == o) {
            return true;
         } else if (!(o instanceof OpenSslSession)) {
            return false;
         } else {
