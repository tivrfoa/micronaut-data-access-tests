...
public final class JdkSslServerContext extends JdkSslContext {
   ...
   JdkSslServerContext(
      ...
      super(
         newSSLContext(
            provider, trustCertCollection, trustManagerFactory, keyCertChain, key, keyPassword, keyManagerFactory, sessionCacheSize, sessionTimeout, keyStore
         ),
         false,
         ciphers,
         cipherFilter,
      ...
      if (key == null && keyManagerFactory == null) {
         ...
         try {
            ...
            if (var14 instanceof SSLException) {
               ...
               throw new SSLException("failed to initialize the server-side SSL context", var14);
            }
         }
      }
   }
