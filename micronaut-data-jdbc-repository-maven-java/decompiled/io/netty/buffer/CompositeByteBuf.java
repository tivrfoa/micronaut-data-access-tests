...
public class CompositeByteBuf extends AbstractReferenceCountedByteBuf implements Iterable<ByteBuf> {
               ...
               if (len > 0) {
                  this.addComp(
                     ...
                     new CompositeByteBuf.Component(
                        component.srcBuf.retain(), component.srcIdx(fromIdx), component.buf, component.idx(fromIdx), cidx, len, null
                     )
                  );
               }
   ...
   public Iterator<ByteBuf> iterator() {
      this.ensureAccessible();
      return (Iterator<ByteBuf>)(this.componentCount == 0 ? EMPTY_ITERATOR : new CompositeByteBuf.CompositeByteBufIterator());
   }
   ...
   public ByteBuffer[] nioBuffers(int index, int length) {
      ...
      if (length == 0) {
         ...
         try {
            ...
            var11 = (ByteBuffer[])buffers.toArray(new ByteBuffer[0]);
         } finally {
            buffers.recycle();
         }
   ...
   private void shiftComps(int i, int count) {
      ...
      if (newSize > this.components.length) {
         ...
         if (i == size) {
            newArr = (CompositeByteBuf.Component[])Arrays.copyOf(this.components, newArrSize, CompositeByteBuf.Component[].class);
         } else {
