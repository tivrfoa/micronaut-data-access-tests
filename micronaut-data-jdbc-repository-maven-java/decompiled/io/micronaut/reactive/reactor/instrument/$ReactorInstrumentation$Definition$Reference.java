...
public final class $ReactorInstrumentation$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
         ...
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  ...
                  new AnnotationValue(
                     "io.micronaut.context.annotation.Requires",
                     AnnotationUtil.mapOf("classes", new AnnotationClassValue[]{$micronaut_load_class_value_5(), $micronaut_load_class_value_6()}),
                     var0
                  )
               }
            ),
   ...
   public $ReactorInstrumentation$Definition$Reference() {
      super(
         "io.micronaut.reactive.reactor.instrument.ReactorInstrumentation",
         "io.micronaut.reactive.reactor.instrument.$ReactorInstrumentation$Definition",
         $ANNOTATION_METADATA,
         false,
         true,
         true,
   ...
   public BeanDefinition load() {
      return new $ReactorInstrumentation$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $ReactorInstrumentation$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return ReactorInstrumentation.class;
   }
}
