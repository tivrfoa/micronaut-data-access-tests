...
public final class $DefaultValueExtractors$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $DefaultValueExtractors$Definition$Reference() {
      super(
         "io.micronaut.validation.validator.extractors.DefaultValueExtractors",
         "io.micronaut.validation.validator.extractors.$DefaultValueExtractors$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $DefaultValueExtractors$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $DefaultValueExtractors$Definition.class;
   }
