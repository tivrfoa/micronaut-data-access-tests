...
public final class $PatternValidator$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $PatternValidator$Definition$Reference() {
      super(
         "io.micronaut.validation.validator.constraints.PatternValidator",
         "io.micronaut.validation.validator.constraints.$PatternValidator$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public Class getBeanDefinitionType() {
      return $PatternValidator$Definition.class;
   }
