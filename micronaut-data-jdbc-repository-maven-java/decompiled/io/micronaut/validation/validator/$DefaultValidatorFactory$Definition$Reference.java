...
public final class $DefaultValidatorFactory$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $DefaultValidatorFactory$Definition$Reference() {
      super(
         "io.micronaut.validation.validator.DefaultValidatorFactory",
         "io.micronaut.validation.validator.$DefaultValidatorFactory$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $DefaultValidatorFactory$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $DefaultValidatorFactory$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return DefaultValidatorFactory.class;
   }
}
