...
public final class $HeartbeatConfiguration$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   public static final AnnotationMetadata $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
      AnnotationUtil.mapOf(
         "io.micronaut.context.annotation.ConfigurationProperties",
         AnnotationUtil.mapOf("value", "micronaut.heartbeat"),
         "io.micronaut.context.annotation.ConfigurationReader",
         AnnotationUtil.mapOf("prefix", "micronaut.heartbeat")
      ),
      AnnotationUtil.mapOf(
         "io.micronaut.context.annotation.ConfigurationReader",
         AnnotationUtil.mapOf("value", "micronaut.heartbeat"),
   ...
   public $HeartbeatConfiguration$Definition$Reference() {
      super(
         "io.micronaut.health.HeartbeatConfiguration",
         "io.micronaut.health.$HeartbeatConfiguration$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $HeartbeatConfiguration$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $HeartbeatConfiguration$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return HeartbeatConfiguration.class;
   }
}
