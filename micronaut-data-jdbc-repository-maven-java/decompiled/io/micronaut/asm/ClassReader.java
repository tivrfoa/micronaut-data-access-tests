...
public class ClassReader {
   ...
   public void accept(ClassVisitor classVisitor, Attribute[] attributePrototypes, int parsingOptions) {
      ...
      if (runtimeVisibleAnnotationsOffset != 0) {
         ...
         for(currentAnnotationOffset = runtimeVisibleAnnotationsOffset + 2;
            numAnnotations-- > 0;
      ...
      if (runtimeInvisibleAnnotationsOffset != 0) {
         ...
         int currentAnnotationOffset;
         String annotationDescriptor;
         for(currentAnnotationOffset = runtimeInvisibleAnnotationsOffset + 2;
            numAnnotations-- > 0;
            currentAnnotationOffset = this.readElementValues(
      ...
      if (runtimeVisibleTypeAnnotationsOffset != 0) {
         ...
         int currentAnnotationOffset;
         String annotationDescriptor;
         for(currentAnnotationOffset = runtimeVisibleTypeAnnotationsOffset + 2;
            numAnnotations-- > 0;
            currentAnnotationOffset = this.readElementValues(
      ...
      if (runtimeInvisibleTypeAnnotationsOffset != 0) {
         ...
         int currentAnnotationOffset;
         String annotationDescriptor;
         for(currentAnnotationOffset = runtimeInvisibleTypeAnnotationsOffset + 2;
            numAnnotations-- > 0;
            currentAnnotationOffset = this.readElementValues(
   ...
   private void readCode(MethodVisitor methodVisitor, Context context, int codeOffset) {
      ...
      if (codeLength > this.classFileBuffer.length - currentOffset) {
         ...
         while(currentOffset < bytecodeEndOffset) {
            ...
            for(;
               visibleTypeAnnotationOffsets != null
                  && attributeLength < visibleTypeAnnotationOffsets.length
         ...
         if (localVariableTableOffset != 0 && (context.parsingOptions & 2) == 0) {
            ...
            int index;
            String signature;
            for(int var50 = localVariableTableOffset + 2;
               ...
               startPc = this.readUnsignedShort(var50);
               length = this.readUnsignedShort(var50 + 2);
               name = this.readUTF8(var50 + 4, charBuffer);
               descriptor = this.readUTF8(var50 + 6, charBuffer);
               index = this.readUnsignedShort(var50 + 8);
               var50 += 10;
               signature = null;
               if (typeTable != null) {
