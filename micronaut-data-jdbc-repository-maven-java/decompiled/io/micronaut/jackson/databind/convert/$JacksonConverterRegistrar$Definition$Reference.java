...
public final class $JacksonConverterRegistrar$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $JacksonConverterRegistrar$Definition$Reference() {
      super(
         "io.micronaut.jackson.databind.convert.JacksonConverterRegistrar",
         "io.micronaut.jackson.databind.convert.$JacksonConverterRegistrar$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $JacksonConverterRegistrar$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $JacksonConverterRegistrar$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return JacksonConverterRegistrar.class;
   }
}
