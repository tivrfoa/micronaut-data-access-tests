...
public final class $ResourceLoaderFactory$FileSystemResourceLoader1$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $ResourceLoaderFactory$FileSystemResourceLoader1$Definition$Reference() {
      super(
         "io.micronaut.core.io.file.FileSystemResourceLoader",
         "io.micronaut.http.resource.$ResourceLoaderFactory$FileSystemResourceLoader1$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $ResourceLoaderFactory$FileSystemResourceLoader1$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $ResourceLoaderFactory$FileSystemResourceLoader1$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return FileSystemResourceLoader.class;
   }
}
