...
// $FF: synthetic class
@Generated
final class $JsonError$Introspection extends AbstractInitializableBeanIntrospection {
   ...
   public $JsonError$Introspection() {
      super(JsonError.class, $JsonError$IntrospectionRef.$ANNOTATION_METADATA, null, $CONSTRUCTOR_ARGUMENTS, $PROPERTIES_REFERENCES, null);
   }
   ...
   protected final Object dispatchOne(int var1, Object var2, Object var3) {
      switch(var1) {
         case 0:
            return ((JsonError)var2).getMessage();
         case 1:
            ((JsonError)var2).setMessage((String)var3);
            return null;
         case 2:
            return ((JsonError)var2).getLogref();
         case 3:
            throw new UnsupportedOperationException(
               "Cannot mutate property [logref] that is not mutable via a setter method or constructor argument for type: io.micronaut.http.hateoas.JsonError"
            );
         case 4:
            return ((JsonError)var2).getPath();
         case 5:
            throw new UnsupportedOperationException(
               "Cannot mutate property [path] that is not mutable via a setter method or constructor argument for type: io.micronaut.http.hateoas.JsonError"
            );
         case 6:
            return ((JsonError)var2).getLinks();
         case 7:
            throw new UnsupportedOperationException(
               "Cannot mutate property [links] that is not mutable via a setter method or constructor argument for type: io.micronaut.http.hateoas.JsonError"
            );
         case 8:
            return ((JsonError)var2).getEmbedded();
         case 9:
            throw new UnsupportedOperationException(
               "Cannot mutate property [embedded] that is not mutable via a setter method or constructor argument for type: io.micronaut.http.hateoas.JsonError"
            );
         default:
   ...
   public Object instantiateInternal(Object[] var1) {
      return new JsonError((String)var1[0]);
   }
}
