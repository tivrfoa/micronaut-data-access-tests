...
public final class $EpollAvailabilityCondition$IntrospectionRef extends AbstractBeanIntrospectionReference {
   ...
   public BeanIntrospection load() {
      return new $EpollAvailabilityCondition$Introspection();
   }

   @Override
   public String getName() {
      return "io.micronaut.http.netty.channel.EpollAvailabilityCondition";
   }

   @Override
   public Class getBeanType() {
      return EpollAvailabilityCondition.class;
   }
