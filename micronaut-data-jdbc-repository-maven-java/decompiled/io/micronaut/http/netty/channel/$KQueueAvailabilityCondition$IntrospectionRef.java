...
public final class $KQueueAvailabilityCondition$IntrospectionRef extends AbstractBeanIntrospectionReference {
   ...
   public BeanIntrospection load() {
      return new $KQueueAvailabilityCondition$Introspection();
   }

   @Override
   public String getName() {
      return "io.micronaut.http.netty.channel.KQueueAvailabilityCondition";
   }

   @Override
   public Class getBeanType() {
      return KQueueAvailabilityCondition.class;
   }
