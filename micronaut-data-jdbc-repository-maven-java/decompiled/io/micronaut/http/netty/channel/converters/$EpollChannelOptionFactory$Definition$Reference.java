...
public final class $EpollChannelOptionFactory$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $EpollChannelOptionFactory$Definition$Reference() {
      super(
         "io.micronaut.http.netty.channel.converters.EpollChannelOptionFactory",
         "io.micronaut.http.netty.channel.converters.$EpollChannelOptionFactory$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $EpollChannelOptionFactory$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $EpollChannelOptionFactory$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return EpollChannelOptionFactory.class;
   }
}
