...
public final class $DefaultChannelOptionFactory$ReflectConfig implements GraalReflectionConfigurer {
         ...
         AnnotationUtil.mapOf(
            ...
            new AnnotationValue[]{
               new AnnotationValue(
                  ...
                  AnnotationUtil.mapOf(
                     "accessType",
                     new TypeHint.AccessType[]{TypeHint.AccessType.ALL_DECLARED_FIELDS},
                     "type",
