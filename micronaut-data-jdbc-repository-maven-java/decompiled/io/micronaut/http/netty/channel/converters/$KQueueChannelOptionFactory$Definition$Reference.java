...
public final class $KQueueChannelOptionFactory$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
               ...
               new AnnotationValue[]{
                  new AnnotationValue(
                     ...
                     AnnotationUtil.mapOf(
                        ...
                        "condition",
                        new AnnotationClassValue<>(new KQueueAvailabilityCondition())
                     ),
   ...
   public $KQueueChannelOptionFactory$Definition$Reference() {
      super(
         "io.micronaut.http.netty.channel.converters.KQueueChannelOptionFactory",
         "io.micronaut.http.netty.channel.converters.$KQueueChannelOptionFactory$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $KQueueChannelOptionFactory$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $KQueueChannelOptionFactory$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return KQueueChannelOptionFactory.class;
   }
}
