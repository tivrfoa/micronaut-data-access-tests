...
public final class $DefaultChannelOptionFactory$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   static {
      ...
      $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  new AnnotationValue(
                     ...
                     AnnotationUtil.mapOf("missingBeans", new AnnotationClassValue[]{$micronaut_load_class_value_4(), $micronaut_load_class_value_5()}),
            ...
            AnnotationUtil.mapOf("accessType", new String[]{"ALL_DECLARED_FIELDS"}, "value", new AnnotationClassValue[]{$micronaut_load_class_value_6()}),
   ...
   public $DefaultChannelOptionFactory$Definition$Reference() {
      super(
         "io.micronaut.http.netty.channel.converters.DefaultChannelOptionFactory",
         "io.micronaut.http.netty.channel.converters.$DefaultChannelOptionFactory$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $DefaultChannelOptionFactory$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $DefaultChannelOptionFactory$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return DefaultChannelOptionFactory.class;
   }
}
