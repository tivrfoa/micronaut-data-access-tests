...
public final class $KQueueEventLoopGroupFactory$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $KQueueEventLoopGroupFactory$Definition$Reference() {
      super(
         "io.micronaut.http.netty.channel.KQueueEventLoopGroupFactory",
         "io.micronaut.http.netty.channel.$KQueueEventLoopGroupFactory$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $KQueueEventLoopGroupFactory$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $KQueueEventLoopGroupFactory$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return KQueueEventLoopGroupFactory.class;
   }
}
