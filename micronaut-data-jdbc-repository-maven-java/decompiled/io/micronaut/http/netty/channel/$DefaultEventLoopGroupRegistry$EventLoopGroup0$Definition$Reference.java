...
public final class $DefaultEventLoopGroupRegistry$EventLoopGroup0$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $DefaultEventLoopGroupRegistry$EventLoopGroup0$Definition$Reference() {
      super(
         "io.netty.channel.EventLoopGroup",
         "io.micronaut.http.netty.channel.$DefaultEventLoopGroupRegistry$EventLoopGroup0$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $DefaultEventLoopGroupRegistry$EventLoopGroup0$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $DefaultEventLoopGroupRegistry$EventLoopGroup0$Definition.class;
   }
