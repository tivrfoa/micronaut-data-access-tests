...
public final class $NettyServerWebSocketBroadcaster$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $NettyServerWebSocketBroadcaster$Definition$Reference() {
      super(
         "io.micronaut.http.netty.websocket.NettyServerWebSocketBroadcaster",
         "io.micronaut.http.netty.websocket.$NettyServerWebSocketBroadcaster$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $NettyServerWebSocketBroadcaster$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $NettyServerWebSocketBroadcaster$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return NettyServerWebSocketBroadcaster.class;
   }
}
