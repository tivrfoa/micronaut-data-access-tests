...
public final class $NettyGlobalConfiguration$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   public static final AnnotationMetadata $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
      AnnotationUtil.mapOf(
         ...
         AnnotationUtil.mapOf("prefix", "netty")
      ),
      AnnotationUtil.mapOf(
         "io.micronaut.context.annotation.ConfigurationReader",
         AnnotationUtil.mapOf("value", "netty"),
   ...
   public $NettyGlobalConfiguration$Definition$Reference() {
      super(
         "io.micronaut.http.netty.configuration.NettyGlobalConfiguration",
         "io.micronaut.http.netty.configuration.$NettyGlobalConfiguration$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $NettyGlobalConfiguration$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $NettyGlobalConfiguration$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return NettyGlobalConfiguration.class;
   }
}
