...
public final class $CoroutineHelper$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $CoroutineHelper$Definition$Reference() {
      super(
         "io.micronaut.http.server.CoroutineHelper",
         "io.micronaut.http.server.$CoroutineHelper$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $CoroutineHelper$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $CoroutineHelper$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return CoroutineHelper.class;
   }
}
