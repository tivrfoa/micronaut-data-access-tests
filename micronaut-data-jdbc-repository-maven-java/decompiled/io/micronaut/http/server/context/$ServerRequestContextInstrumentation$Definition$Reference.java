...
public final class $ServerRequestContextInstrumentation$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $ServerRequestContextInstrumentation$Definition$Reference() {
      super(
         "io.micronaut.http.server.context.ServerRequestContextInstrumentation",
         "io.micronaut.http.server.context.$ServerRequestContextInstrumentation$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $ServerRequestContextInstrumentation$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $ServerRequestContextInstrumentation$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return ServerRequestContextInstrumentation.class;
   }
}
