...
public final class $HttpServerConfiguration$CorsConfiguration$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   public static final AnnotationMetadata $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
      AnnotationUtil.mapOf(
         "io.micronaut.context.annotation.ConfigurationProperties",
         AnnotationUtil.mapOf("value", "cors"),
         "io.micronaut.context.annotation.ConfigurationReader",
         AnnotationUtil.mapOf("prefix", "micronaut.server.cors")
      ),
      AnnotationUtil.mapOf(
         "io.micronaut.context.annotation.ConfigurationReader",
         AnnotationUtil.mapOf("value", "cors"),
   ...
   public $HttpServerConfiguration$CorsConfiguration$Definition$Reference() {
      super(
         "io.micronaut.http.server.HttpServerConfiguration$CorsConfiguration",
         "io.micronaut.http.server.$HttpServerConfiguration$CorsConfiguration$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $HttpServerConfiguration$CorsConfiguration$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $HttpServerConfiguration$CorsConfiguration$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return HttpServerConfiguration.CorsConfiguration.class;
   }
}
