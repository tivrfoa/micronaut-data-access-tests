...
public final class $NettyHttpServer$ReflectConfig implements GraalReflectionConfigurer {
         ...
         AnnotationUtil.mapOf(
            ...
            new AnnotationValue[]{
               new AnnotationValue(
                  ...
                  AnnotationUtil.mapOf(
                     "accessType",
                     new TypeHint.AccessType[]{TypeHint.AccessType.ALL_DECLARED_CONSTRUCTORS, TypeHint.AccessType.ALL_DECLARED_FIELDS},
                     "type",
