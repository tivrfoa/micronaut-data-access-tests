...
public final class $NettyConverters$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $NettyConverters$Definition$Reference() {
      super(
         "io.micronaut.http.server.netty.converters.NettyConverters",
         "io.micronaut.http.server.netty.converters.$NettyConverters$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $NettyConverters$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $NettyConverters$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return NettyConverters.class;
   }
}
