...
public final class $FileTypeHandlerConfiguration$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   public static final AnnotationMetadata $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
      AnnotationUtil.mapOf(
         "io.micronaut.context.annotation.ConfigurationProperties",
         AnnotationUtil.mapOf("value", "netty.responses.file"),
         "io.micronaut.context.annotation.ConfigurationReader",
         AnnotationUtil.mapOf("prefix", "netty.responses.file"),
   ...
   public $FileTypeHandlerConfiguration$Definition$Reference() {
      super(
         "io.micronaut.http.server.netty.types.files.FileTypeHandlerConfiguration",
         "io.micronaut.http.server.netty.types.files.$FileTypeHandlerConfiguration$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $FileTypeHandlerConfiguration$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $FileTypeHandlerConfiguration$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return FileTypeHandlerConfiguration.class;
   }
}
