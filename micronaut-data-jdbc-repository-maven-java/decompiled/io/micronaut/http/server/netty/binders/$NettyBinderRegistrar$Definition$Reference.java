...
public final class $NettyBinderRegistrar$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $NettyBinderRegistrar$Definition$Reference() {
      super(
         "io.micronaut.http.server.netty.binders.NettyBinderRegistrar",
         "io.micronaut.http.server.netty.binders.$NettyBinderRegistrar$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $NettyBinderRegistrar$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $NettyBinderRegistrar$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return NettyBinderRegistrar.class;
   }
}
