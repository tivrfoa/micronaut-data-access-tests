...
public final class $JsonViewServerFilter$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   static {
      ...
      $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf("value", new String[]{"/**"})
         ),
   ...
   public $JsonViewServerFilter$Definition$Reference() {
      super(
         "io.micronaut.http.server.netty.jackson.JsonViewServerFilter",
         "io.micronaut.http.server.netty.jackson.$JsonViewServerFilter$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $JsonViewServerFilter$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $JsonViewServerFilter$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return JsonViewServerFilter.class;
   }
}
