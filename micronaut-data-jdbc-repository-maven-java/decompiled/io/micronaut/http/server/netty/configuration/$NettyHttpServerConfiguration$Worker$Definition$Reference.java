...
public final class $NettyHttpServerConfiguration$Worker$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   public static final AnnotationMetadata $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
      AnnotationUtil.mapOf(
         "io.micronaut.context.annotation.ConfigurationProperties",
         AnnotationUtil.mapOf("value", "worker"),
         "io.micronaut.context.annotation.ConfigurationReader",
         AnnotationUtil.mapOf("prefix", "micronaut.server.netty.worker")
      ),
      AnnotationUtil.mapOf(
         "io.micronaut.context.annotation.ConfigurationReader",
         AnnotationUtil.mapOf("value", "worker"),
   ...
   public $NettyHttpServerConfiguration$Worker$Definition$Reference() {
      super(
         "io.micronaut.http.server.netty.configuration.NettyHttpServerConfiguration$Worker",
         "io.micronaut.http.server.netty.configuration.$NettyHttpServerConfiguration$Worker$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $NettyHttpServerConfiguration$Worker$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $NettyHttpServerConfiguration$Worker$Definition.class;
   }
