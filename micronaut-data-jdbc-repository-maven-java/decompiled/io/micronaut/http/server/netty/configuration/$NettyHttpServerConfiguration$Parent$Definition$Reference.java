...
public final class $NettyHttpServerConfiguration$Parent$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   static {
      ...
      $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf("value", "parent"),
            "io.micronaut.context.annotation.ConfigurationReader",
            AnnotationUtil.mapOf("prefix", "micronaut.server.netty.parent"),
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  new AnnotationValue(
                     ...
                     AnnotationUtil.mapOf("missingProperty", "micronaut.netty.event-loops.parent"),
         ...
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  new AnnotationValue(
                     "io.micronaut.context.annotation.Requires", AnnotationUtil.mapOf("missingProperty", "micronaut.netty.event-loops.parent"), var0
                  )
               }
            )
         ),
   ...
   public $NettyHttpServerConfiguration$Parent$Definition$Reference() {
      super(
         "io.micronaut.http.server.netty.configuration.NettyHttpServerConfiguration$Parent",
         "io.micronaut.http.server.netty.configuration.$NettyHttpServerConfiguration$Parent$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $NettyHttpServerConfiguration$Parent$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $NettyHttpServerConfiguration$Parent$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return NettyHttpServerConfiguration.Parent.class;
   }
}
