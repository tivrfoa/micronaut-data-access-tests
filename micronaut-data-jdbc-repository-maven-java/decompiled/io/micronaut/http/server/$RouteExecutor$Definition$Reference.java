...
public final class $RouteExecutor$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $RouteExecutor$Definition$Reference() {
      super(
   ...
   public BeanDefinition load() {
      return new $RouteExecutor$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $RouteExecutor$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return RouteExecutor.class;
   }
}
