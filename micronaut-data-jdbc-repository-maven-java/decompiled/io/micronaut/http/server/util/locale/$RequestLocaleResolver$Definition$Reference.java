...
public final class $RequestLocaleResolver$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  new AnnotationValue(
                     ...
                     AnnotationUtil.mapOf("notEquals", "false", "property", "micronaut.server.locale-resolution.header"),
   ...
   public $RequestLocaleResolver$Definition$Reference() {
      super(
         "io.micronaut.http.server.util.locale.RequestLocaleResolver",
         "io.micronaut.http.server.util.locale.$RequestLocaleResolver$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $RequestLocaleResolver$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $RequestLocaleResolver$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return RequestLocaleResolver.class;
   }
}
