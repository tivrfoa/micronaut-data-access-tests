...
public final class $CompositeHttpLocaleResolver$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $CompositeHttpLocaleResolver$Definition$Reference() {
      super(
         "io.micronaut.http.server.util.locale.CompositeHttpLocaleResolver",
         "io.micronaut.http.server.util.locale.$CompositeHttpLocaleResolver$Definition",
         $ANNOTATION_METADATA,
         true,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $CompositeHttpLocaleResolver$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $CompositeHttpLocaleResolver$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return CompositeHttpLocaleResolver.class;
   }
}
