...
public final class $CookieLocaleResolver$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
      ...
      $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  new AnnotationValue(
                     ...
                     AnnotationUtil.mapOf("property", "micronaut.server.locale-resolution.cookie-name"),
         ...
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  new AnnotationValue(
                     "io.micronaut.context.annotation.Requires", AnnotationUtil.mapOf("property", "micronaut.server.locale-resolution.cookie-name"), var0
                  )
               }
            ),
   ...
   public $CookieLocaleResolver$Definition$Reference() {
      super(
         "io.micronaut.http.server.util.locale.CookieLocaleResolver",
         "io.micronaut.http.server.util.locale.$CookieLocaleResolver$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $CookieLocaleResolver$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $CookieLocaleResolver$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return CookieLocaleResolver.class;
   }
}
