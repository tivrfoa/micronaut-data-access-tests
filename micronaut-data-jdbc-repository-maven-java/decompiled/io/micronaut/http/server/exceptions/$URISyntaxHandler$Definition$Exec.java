...
// $FF: synthetic class
@Generated
final class $URISyntaxHandler$Definition$Exec extends AbstractExecutableMethodsDefinition {
   private static final AbstractExecutableMethodsDefinition.MethodReference[] $METHODS_REFERENCES = new AbstractExecutableMethodsDefinition.MethodReference[]{
      new AbstractExecutableMethodsDefinition.MethodReference(
         ...
         new Argument[]{
            Argument.of(HttpRequest.class, "request", null, Argument.ofTypeVariable(Object.class, "B")), Argument.of(URISyntaxException.class, "exception")
         },
         false,
         false
      )
   ...
   public $URISyntaxHandler$Definition$Exec() {
   ...
   protected final Object dispatch(int var1, Object var2, Object[] var3) {
      switch(var1) {
         case 0:
            return ((URISyntaxHandler)var2).handle((HttpRequest)var3[0], (URISyntaxException)var3[1]);
         default:
   ...
   protected final Method getTargetMethodByIndex(int var1) {
      switch(var1) {
         case 0:
            return ReflectionUtils.getRequiredMethod(URISyntaxHandler.class, "handle", HttpRequest.class, URISyntaxException.class);
         default:
            throw this.unknownDispatchAtIndexException(var1);
      }
   }
