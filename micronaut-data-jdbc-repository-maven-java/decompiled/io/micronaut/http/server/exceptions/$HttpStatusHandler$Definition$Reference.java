...
public final class $HttpStatusHandler$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $HttpStatusHandler$Definition$Reference() {
      super(
         "io.micronaut.http.server.exceptions.HttpStatusHandler",
         "io.micronaut.http.server.exceptions.$HttpStatusHandler$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $HttpStatusHandler$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $HttpStatusHandler$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return HttpStatusHandler.class;
   }
}
