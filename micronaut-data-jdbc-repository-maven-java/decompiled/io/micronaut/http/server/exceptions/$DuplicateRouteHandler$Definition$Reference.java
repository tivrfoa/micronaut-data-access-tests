...
public final class $DuplicateRouteHandler$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $DuplicateRouteHandler$Definition$Reference() {
      super(
         "io.micronaut.http.server.exceptions.DuplicateRouteHandler",
         "io.micronaut.http.server.exceptions.$DuplicateRouteHandler$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $DuplicateRouteHandler$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $DuplicateRouteHandler$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return DuplicateRouteHandler.class;
   }
}
