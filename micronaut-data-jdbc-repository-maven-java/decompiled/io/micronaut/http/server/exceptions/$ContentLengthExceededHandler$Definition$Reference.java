...
public final class $ContentLengthExceededHandler$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $ContentLengthExceededHandler$Definition$Reference() {
      super(
         "io.micronaut.http.server.exceptions.ContentLengthExceededHandler",
         "io.micronaut.http.server.exceptions.$ContentLengthExceededHandler$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $ContentLengthExceededHandler$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $ContentLengthExceededHandler$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return ContentLengthExceededHandler.class;
   }
}
