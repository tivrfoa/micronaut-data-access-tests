...
public final class $URISyntaxHandler$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $URISyntaxHandler$Definition$Reference() {
      super(
         "io.micronaut.http.server.exceptions.URISyntaxHandler",
         "io.micronaut.http.server.exceptions.$URISyntaxHandler$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $URISyntaxHandler$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $URISyntaxHandler$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return URISyntaxHandler.class;
   }
}
