...
public final class $JsonExceptionHandler$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $JsonExceptionHandler$Definition$Reference() {
      super(
         "io.micronaut.http.server.exceptions.JsonExceptionHandler",
         "io.micronaut.http.server.exceptions.$JsonExceptionHandler$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $JsonExceptionHandler$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $JsonExceptionHandler$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return JsonExceptionHandler.class;
   }
}
