...
public final class $ConversionErrorHandler$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $ConversionErrorHandler$Definition$Reference() {
      super(
         "io.micronaut.http.server.exceptions.ConversionErrorHandler",
         "io.micronaut.http.server.exceptions.$ConversionErrorHandler$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $ConversionErrorHandler$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $ConversionErrorHandler$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return ConversionErrorHandler.class;
   }
}
