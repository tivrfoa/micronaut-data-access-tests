...
public final class $BasicAuthArgumentBinder$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $BasicAuthArgumentBinder$Definition$Reference() {
      super(
         "io.micronaut.http.server.binding.BasicAuthArgumentBinder",
         "io.micronaut.http.server.binding.$BasicAuthArgumentBinder$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $BasicAuthArgumentBinder$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $BasicAuthArgumentBinder$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return BasicAuthArgumentBinder.class;
   }
}
