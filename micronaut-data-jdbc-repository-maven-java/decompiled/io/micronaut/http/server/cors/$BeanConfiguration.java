      ...
      $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  new AnnotationValue(
                     ...
                     AnnotationUtil.mapOf("property", "micronaut.server.cors.enabled", "value", "true"),
         ...
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  new AnnotationValue(
                     "io.micronaut.context.annotation.Requires", AnnotationUtil.mapOf("property", "micronaut.server.cors.enabled", "value", "true"), var0
                  )
               }
            )
         ),
