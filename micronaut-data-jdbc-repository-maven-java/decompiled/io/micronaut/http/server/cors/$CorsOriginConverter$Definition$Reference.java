...
public final class $CorsOriginConverter$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $CorsOriginConverter$Definition$Reference() {
      super(
         "io.micronaut.http.server.cors.CorsOriginConverter",
         "io.micronaut.http.server.cors.$CorsOriginConverter$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $CorsOriginConverter$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $CorsOriginConverter$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return CorsOriginConverter.class;
   }
}
