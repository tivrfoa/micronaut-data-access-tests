...
public final class $CodecConfiguration$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   public static final AnnotationMetadata $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
      AnnotationUtil.mapOf(
         "io.micronaut.context.annotation.ConfigurationReader",
         AnnotationUtil.mapOf("prefix", "micronaut.codec.*"),
         "io.micronaut.context.annotation.EachProperty",
         AnnotationUtil.mapOf("value", "micronaut.codec")
      ),
      AnnotationUtil.mapOf(
         "io.micronaut.context.annotation.ConfigurationReader",
         AnnotationUtil.mapOf("value", "micronaut.codec"),
   ...
   public $CodecConfiguration$Definition$Reference() {
      super(
         "io.micronaut.http.codec.CodecConfiguration",
         "io.micronaut.http.codec.$CodecConfiguration$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $CodecConfiguration$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $CodecConfiguration$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return CodecConfiguration.class;
   }
}
