...
public final class $HttpClientIntroductionAdvice$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $HttpClientIntroductionAdvice$Definition$Reference() {
      super(
         "io.micronaut.http.client.interceptor.HttpClientIntroductionAdvice",
         "io.micronaut.http.client.interceptor.$HttpClientIntroductionAdvice$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $HttpClientIntroductionAdvice$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $HttpClientIntroductionAdvice$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return HttpClientIntroductionAdvice.class;
   }
}
