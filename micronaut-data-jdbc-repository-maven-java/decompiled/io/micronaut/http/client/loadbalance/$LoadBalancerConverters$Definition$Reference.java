...
public final class $LoadBalancerConverters$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $LoadBalancerConverters$Definition$Reference() {
      super(
         "io.micronaut.http.client.loadbalance.LoadBalancerConverters",
         "io.micronaut.http.client.loadbalance.$LoadBalancerConverters$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $LoadBalancerConverters$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $LoadBalancerConverters$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return LoadBalancerConverters.class;
   }
}
