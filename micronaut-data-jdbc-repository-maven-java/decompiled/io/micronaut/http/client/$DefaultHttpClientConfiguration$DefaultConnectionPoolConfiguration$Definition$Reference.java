...
public final class $DefaultHttpClientConfiguration$DefaultConnectionPoolConfiguration$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   public static final AnnotationMetadata $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
      AnnotationUtil.mapOf(
         ...
         AnnotationUtil.mapOf("prefix", "micronaut.http.client.pool"),
   ...
   public $DefaultHttpClientConfiguration$DefaultConnectionPoolConfiguration$Definition$Reference() {
      super(
         "io.micronaut.http.client.DefaultHttpClientConfiguration$DefaultConnectionPoolConfiguration",
         "io.micronaut.http.client.$DefaultHttpClientConfiguration$DefaultConnectionPoolConfiguration$Definition",
         $ANNOTATION_METADATA,
         true,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $DefaultHttpClientConfiguration$DefaultConnectionPoolConfiguration$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $DefaultHttpClientConfiguration$DefaultConnectionPoolConfiguration$Definition.class;
   }
