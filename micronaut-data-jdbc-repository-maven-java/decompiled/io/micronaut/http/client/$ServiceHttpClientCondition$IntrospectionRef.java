...
public final class $ServiceHttpClientCondition$IntrospectionRef extends AbstractBeanIntrospectionReference {
   ...
   public BeanIntrospection load() {
      return new $ServiceHttpClientCondition$Introspection();
   }

   @Override
   public String getName() {
      return "io.micronaut.http.client.ServiceHttpClientCondition";
   }

   @Override
   public Class getBeanType() {
      return ServiceHttpClientCondition.class;
   }
