...
public final class $ServerSslConfiguration$DefaultTrustStoreConfiguration$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   static {
      ...
      $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf("prefix", "micronaut.server.ssl.trust-store"),
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  new AnnotationValue(
                     ...
                     AnnotationUtil.mapOf("property", "micronaut.server.ssl.trust-store"),
         ...
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf(
               "value",
               new AnnotationValue[]{
                  new AnnotationValue("io.micronaut.context.annotation.Requires", AnnotationUtil.mapOf("property", "micronaut.server.ssl.trust-store"), var0)
               }
            )
         ),
         AnnotationUtil.mapOf(
   ...
   public $ServerSslConfiguration$DefaultTrustStoreConfiguration$Definition$Reference() {
      super(
         "io.micronaut.http.ssl.ServerSslConfiguration$DefaultTrustStoreConfiguration",
         "io.micronaut.http.ssl.$ServerSslConfiguration$DefaultTrustStoreConfiguration$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $ServerSslConfiguration$DefaultTrustStoreConfiguration$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $ServerSslConfiguration$DefaultTrustStoreConfiguration$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return ServerSslConfiguration.DefaultTrustStoreConfiguration.class;
   }
}
