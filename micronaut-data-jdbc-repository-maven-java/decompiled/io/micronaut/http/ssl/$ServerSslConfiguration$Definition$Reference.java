...
public final class $ServerSslConfiguration$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $ServerSslConfiguration$Definition$Reference() {
      super(
         "io.micronaut.http.ssl.ServerSslConfiguration",
         "io.micronaut.http.ssl.$ServerSslConfiguration$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $ServerSslConfiguration$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $ServerSslConfiguration$Definition.class;
   }
