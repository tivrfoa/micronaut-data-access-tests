...
public final class $ServerSslConfiguration$DefaultKeyStoreConfiguration$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   static {
      ...
      $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf("prefix", "micronaut.server.ssl.key-store"),
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  new AnnotationValue(
                     ...
                     AnnotationUtil.mapOf("property", "micronaut.server.ssl.key-store"),
         ...
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf(
               "value",
               new AnnotationValue[]{
                  new AnnotationValue("io.micronaut.context.annotation.Requires", AnnotationUtil.mapOf("property", "micronaut.server.ssl.key-store"), var0)
               }
            )
         ),
         AnnotationUtil.mapOf(
   ...
   public $ServerSslConfiguration$DefaultKeyStoreConfiguration$Definition$Reference() {
      super(
         "io.micronaut.http.ssl.ServerSslConfiguration$DefaultKeyStoreConfiguration",
         "io.micronaut.http.ssl.$ServerSslConfiguration$DefaultKeyStoreConfiguration$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $ServerSslConfiguration$DefaultKeyStoreConfiguration$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $ServerSslConfiguration$DefaultKeyStoreConfiguration$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return ServerSslConfiguration.DefaultKeyStoreConfiguration.class;
   }
}
