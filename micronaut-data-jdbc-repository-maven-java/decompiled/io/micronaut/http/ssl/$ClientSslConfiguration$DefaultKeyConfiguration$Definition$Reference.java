...
public final class $ClientSslConfiguration$DefaultKeyConfiguration$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   static {
      ...
      $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf("value", "key"),
            "io.micronaut.context.annotation.ConfigurationReader",
            AnnotationUtil.mapOf("prefix", "micronaut.http.client.ssl.key"),
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  new AnnotationValue(
                     ...
                     AnnotationUtil.mapOf("property", "micronaut.http.client.ssl.key"),
         ...
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf(
               "value",
               new AnnotationValue[]{
                  new AnnotationValue("io.micronaut.context.annotation.Requires", AnnotationUtil.mapOf("property", "micronaut.http.client.ssl.key"), var0)
               }
            )
         ),
         AnnotationUtil.mapOf(
   ...
   public $ClientSslConfiguration$DefaultKeyConfiguration$Definition$Reference() {
      super(
         "io.micronaut.http.ssl.ClientSslConfiguration$DefaultKeyConfiguration",
         "io.micronaut.http.ssl.$ClientSslConfiguration$DefaultKeyConfiguration$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $ClientSslConfiguration$DefaultKeyConfiguration$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $ClientSslConfiguration$DefaultKeyConfiguration$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return ClientSslConfiguration.DefaultKeyConfiguration.class;
   }
}
