...
public final class $ClientSslConfiguration$DefaultTrustStoreConfiguration$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   static {
      ...
      $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf("prefix", "micronaut.http.client.ssl.trust-store"),
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  new AnnotationValue(
                     ...
                     AnnotationUtil.mapOf("property", "micronaut.http.client.ssl.trust-store"),
         ...
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  new AnnotationValue(
                     "io.micronaut.context.annotation.Requires", AnnotationUtil.mapOf("property", "micronaut.http.client.ssl.trust-store"), var0
                  )
               }
            )
         ),
   ...
   public $ClientSslConfiguration$DefaultTrustStoreConfiguration$Definition$Reference() {
      super(
         "io.micronaut.http.ssl.ClientSslConfiguration$DefaultTrustStoreConfiguration",
         "io.micronaut.http.ssl.$ClientSslConfiguration$DefaultTrustStoreConfiguration$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $ClientSslConfiguration$DefaultTrustStoreConfiguration$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $ClientSslConfiguration$DefaultTrustStoreConfiguration$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return ClientSslConfiguration.DefaultTrustStoreConfiguration.class;
   }
}
