...
public final class $DefaultSslConfiguration$DefaultTrustStoreConfiguration$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   public static final AnnotationMetadata $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
      AnnotationUtil.mapOf(
         ...
         AnnotationUtil.mapOf("prefix", "micronaut.ssl.trust-store"),
   ...
   public $DefaultSslConfiguration$DefaultTrustStoreConfiguration$Definition$Reference() {
      super(
         "io.micronaut.http.ssl.DefaultSslConfiguration$DefaultTrustStoreConfiguration",
         "io.micronaut.http.ssl.$DefaultSslConfiguration$DefaultTrustStoreConfiguration$Definition",
         $ANNOTATION_METADATA,
         true,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $DefaultSslConfiguration$DefaultTrustStoreConfiguration$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $DefaultSslConfiguration$DefaultTrustStoreConfiguration$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return DefaultSslConfiguration.DefaultTrustStoreConfiguration.class;
   }
}
