...
public final class $DefaultSslConfiguration$DefaultKeyStoreConfiguration$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   public static final AnnotationMetadata $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
      AnnotationUtil.mapOf(
         ...
         AnnotationUtil.mapOf("prefix", "micronaut.ssl.key-store"),
   ...
   public $DefaultSslConfiguration$DefaultKeyStoreConfiguration$Definition$Reference() {
      super(
         "io.micronaut.http.ssl.DefaultSslConfiguration$DefaultKeyStoreConfiguration",
         "io.micronaut.http.ssl.$DefaultSslConfiguration$DefaultKeyStoreConfiguration$Definition",
         $ANNOTATION_METADATA,
         true,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $DefaultSslConfiguration$DefaultKeyStoreConfiguration$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $DefaultSslConfiguration$DefaultKeyStoreConfiguration$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return DefaultSslConfiguration.DefaultKeyStoreConfiguration.class;
   }
}
