...
public final class $DefaultSslConfiguration$DefaultKeyConfiguration$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   public static final AnnotationMetadata $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
      AnnotationUtil.mapOf(
         ...
         AnnotationUtil.mapOf("prefix", "micronaut.ssl.key"),
   ...
   public $DefaultSslConfiguration$DefaultKeyConfiguration$Definition$Reference() {
      super(
         "io.micronaut.http.ssl.DefaultSslConfiguration$DefaultKeyConfiguration",
         "io.micronaut.http.ssl.$DefaultSslConfiguration$DefaultKeyConfiguration$Definition",
         $ANNOTATION_METADATA,
         true,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $DefaultSslConfiguration$DefaultKeyConfiguration$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $DefaultSslConfiguration$DefaultKeyConfiguration$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return DefaultSslConfiguration.DefaultKeyConfiguration.class;
   }
}
