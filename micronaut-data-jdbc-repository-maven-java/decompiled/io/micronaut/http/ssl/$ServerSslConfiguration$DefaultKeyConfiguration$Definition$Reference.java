...
public final class $ServerSslConfiguration$DefaultKeyConfiguration$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   static {
      ...
      $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf("prefix", "micronaut.server.ssl.key"),
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  new AnnotationValue(
                     ...
                     AnnotationUtil.mapOf("property", "micronaut.server.ssl.key"),
         ...
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf(
               "value",
               new AnnotationValue[]{
                  new AnnotationValue("io.micronaut.context.annotation.Requires", AnnotationUtil.mapOf("property", "micronaut.server.ssl.key"), var0)
               }
            )
         ),
         AnnotationUtil.mapOf(
   ...
   public $ServerSslConfiguration$DefaultKeyConfiguration$Definition$Reference() {
      super(
         "io.micronaut.http.ssl.ServerSslConfiguration$DefaultKeyConfiguration",
         "io.micronaut.http.ssl.$ServerSslConfiguration$DefaultKeyConfiguration$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $ServerSslConfiguration$DefaultKeyConfiguration$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $ServerSslConfiguration$DefaultKeyConfiguration$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return ServerSslConfiguration.DefaultKeyConfiguration.class;
   }
}
