...
public final class $SameSiteConverter$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $SameSiteConverter$Definition$Reference() {
      super(
         "io.micronaut.http.cookie.SameSiteConverter",
         "io.micronaut.http.cookie.$SameSiteConverter$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $SameSiteConverter$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $SameSiteConverter$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return SameSiteConverter.class;
   }
}
