...
public final class $HttpConverterRegistrar$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $HttpConverterRegistrar$Definition$Reference() {
      super(
         "io.micronaut.http.converters.HttpConverterRegistrar",
         "io.micronaut.http.converters.$HttpConverterRegistrar$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $HttpConverterRegistrar$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $HttpConverterRegistrar$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return HttpConverterRegistrar.class;
   }
}
