...
public final class $DigitalOceanInstanceMetadata$IntrospectionRef extends AbstractBeanIntrospectionReference {
   ...
   public BeanIntrospection load() {
      return new $DigitalOceanInstanceMetadata$Introspection();
   }
