...
public final class $DefaultCompositeDiscoveryClient$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $DefaultCompositeDiscoveryClient$Definition$Reference() {
      super(
         "io.micronaut.discovery.DefaultCompositeDiscoveryClient",
         "io.micronaut.discovery.$DefaultCompositeDiscoveryClient$Definition",
         $ANNOTATION_METADATA,
         true,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $DefaultCompositeDiscoveryClient$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $DefaultCompositeDiscoveryClient$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return DefaultCompositeDiscoveryClient.class;
   }
}
