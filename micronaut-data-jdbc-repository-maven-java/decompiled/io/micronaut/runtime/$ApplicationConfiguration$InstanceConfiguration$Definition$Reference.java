...
public final class $ApplicationConfiguration$InstanceConfiguration$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   public static final AnnotationMetadata $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
      AnnotationUtil.mapOf(
         ...
         AnnotationUtil.mapOf("value", "instance"),
         "io.micronaut.context.annotation.ConfigurationReader",
         AnnotationUtil.mapOf("prefix", "micronaut.application.instance")
      ),
      AnnotationUtil.mapOf(
         "io.micronaut.context.annotation.ConfigurationReader",
         AnnotationUtil.mapOf("value", "instance"),
   ...
   public $ApplicationConfiguration$InstanceConfiguration$Definition$Reference() {
      super(
         "io.micronaut.runtime.ApplicationConfiguration$InstanceConfiguration",
         "io.micronaut.runtime.$ApplicationConfiguration$InstanceConfiguration$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $ApplicationConfiguration$InstanceConfiguration$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $ApplicationConfiguration$InstanceConfiguration$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return ApplicationConfiguration.InstanceConfiguration.class;
   }
}
