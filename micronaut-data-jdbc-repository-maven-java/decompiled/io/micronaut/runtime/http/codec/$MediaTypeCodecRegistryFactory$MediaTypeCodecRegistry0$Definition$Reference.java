...
public final class $MediaTypeCodecRegistryFactory$MediaTypeCodecRegistry0$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $MediaTypeCodecRegistryFactory$MediaTypeCodecRegistry0$Definition$Reference() {
      super(
         "io.micronaut.http.codec.MediaTypeCodecRegistry",
         "io.micronaut.runtime.http.codec.$MediaTypeCodecRegistryFactory$MediaTypeCodecRegistry0$Definition",
         $ANNOTATION_METADATA,
         true,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $MediaTypeCodecRegistryFactory$MediaTypeCodecRegistry0$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $MediaTypeCodecRegistryFactory$MediaTypeCodecRegistry0$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return MediaTypeCodecRegistry.class;
   }
}
