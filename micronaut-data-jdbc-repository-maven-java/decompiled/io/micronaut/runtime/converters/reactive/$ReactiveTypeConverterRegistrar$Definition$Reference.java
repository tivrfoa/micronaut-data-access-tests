...
public final class $ReactiveTypeConverterRegistrar$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $ReactiveTypeConverterRegistrar$Definition$Reference() {
      super(
         "io.micronaut.runtime.converters.reactive.ReactiveTypeConverterRegistrar",
         "io.micronaut.runtime.converters.reactive.$ReactiveTypeConverterRegistrar$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $ReactiveTypeConverterRegistrar$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $ReactiveTypeConverterRegistrar$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return ReactiveTypeConverterRegistrar.class;
   }
}
