...
public final class $RefreshScope$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  new AnnotationValue(
                     ...
                     AnnotationUtil.mapOf("notEnv", new String[]{"function", "android"}),
         ...
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  ...
                  new AnnotationValue("io.micronaut.core.annotation.Indexed", AnnotationUtil.mapOf("value", $micronaut_load_class_value_5()), var1)
               }
            ),
            "javax.inject.Singleton",
            Collections.EMPTY_MAP
   ...
   public $RefreshScope$Definition$Reference() {
      super(
         "io.micronaut.runtime.context.scope.refresh.RefreshScope",
         "io.micronaut.runtime.context.scope.refresh.$RefreshScope$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $RefreshScope$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $RefreshScope$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return RefreshScope.class;
   }
}
