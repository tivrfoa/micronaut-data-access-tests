...
public final class $RefreshInterceptor$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $RefreshInterceptor$Definition$Reference() {
      super(
         "io.micronaut.runtime.context.scope.refresh.RefreshInterceptor",
         "io.micronaut.runtime.context.scope.refresh.$RefreshInterceptor$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $RefreshInterceptor$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $RefreshInterceptor$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return RefreshInterceptor.class;
   }
}
