...
public final class $DatasourceConfiguration$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   static {
      ...
      DefaultAnnotationMetadata.registerAnnotationDefaults(
         $micronaut_load_class_value_3(), AnnotationUtil.mapOf("keyFormat", "HYPHENATED", "transformation", "NESTED")
      );
      DefaultAnnotationMetadata.registerAnnotationType($micronaut_load_class_value_4());
   }

   public $DatasourceConfiguration$Definition$Reference() {
      super(
         "io.micronaut.configuration.jdbc.hikari.DatasourceConfiguration",
         "io.micronaut.configuration.jdbc.hikari.$DatasourceConfiguration$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $DatasourceConfiguration$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $DatasourceConfiguration$Definition.class;
   }
