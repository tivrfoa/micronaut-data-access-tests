...
public final class $SpringDataSourceResolver$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $SpringDataSourceResolver$Definition$Reference() {
      super(
         "io.micronaut.jdbc.spring.SpringDataSourceResolver",
         "io.micronaut.jdbc.spring.$SpringDataSourceResolver$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $SpringDataSourceResolver$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $SpringDataSourceResolver$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return SpringDataSourceResolver.class;
   }
}
