...
public final class $DefaultPage$IntrospectionRef extends AbstractBeanIntrospectionReference {
   ...
   public BeanIntrospection load() {
      return new $DefaultPage$Introspection();
   }

   @Override
   public String getName() {
      return "io.micronaut.data.model.DefaultPage";
   }
