...
public final class $SqlQueryBuilder$IntrospectionRef extends AbstractBeanIntrospectionReference {
   ...
   public BeanIntrospection load() {
      return new $SqlQueryBuilder$Introspection();
   }

   @Override
   public String getName() {
      return "io.micronaut.data.model.query.builder.sql.SqlQueryBuilder";
   }
