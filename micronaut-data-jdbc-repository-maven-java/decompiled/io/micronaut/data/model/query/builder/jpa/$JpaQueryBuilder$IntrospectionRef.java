...
public final class $JpaQueryBuilder$IntrospectionRef extends AbstractBeanIntrospectionReference {
   ...
   public BeanIntrospection load() {
      return new $JpaQueryBuilder$Introspection();
   }

   @Override
   public String getName() {
      return "io.micronaut.data.model.query.builder.jpa.JpaQueryBuilder";
   }

   @Override
   public Class getBeanType() {
      return JpaQueryBuilder.class;
   }
