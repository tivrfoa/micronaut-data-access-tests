...
public final class $DefaultPageable$IntrospectionRef extends AbstractBeanIntrospectionReference {
   ...
   static {
      ...
      DefaultAnnotationMetadata.registerAnnotationDefaults($micronaut_load_class_value_2(), AnnotationUtil.mapOf("value", true));
      DefaultAnnotationMetadata.registerAnnotationType($micronaut_load_class_value_3());
   }

   @Override
   public BeanIntrospection load() {
      return new $DefaultPageable$Introspection();
   }
