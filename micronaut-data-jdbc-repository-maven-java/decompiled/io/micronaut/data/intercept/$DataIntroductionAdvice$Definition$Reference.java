...
public final class $DataIntroductionAdvice$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $DataIntroductionAdvice$Definition$Reference() {
      super(
         "io.micronaut.data.intercept.DataIntroductionAdvice",
         "io.micronaut.data.intercept.$DataIntroductionAdvice$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $DataIntroductionAdvice$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $DataIntroductionAdvice$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return DataIntroductionAdvice.class;
   }
}
