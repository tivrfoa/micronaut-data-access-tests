...
public final class $OracleTypeConvertersFactory$FromOracleTimestampToInstant5$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $OracleTypeConvertersFactory$FromOracleTimestampToInstant5$Definition$Reference() {
      super(
         "io.micronaut.data.runtime.convert.DataTypeConverter",
         "io.micronaut.data.jdbc.convert.vendor.$OracleTypeConvertersFactory$FromOracleTimestampToInstant5$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $OracleTypeConvertersFactory$FromOracleTimestampToInstant5$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $OracleTypeConvertersFactory$FromOracleTimestampToInstant5$Definition.class;
   }
