...
// $FF: synthetic class
@Generated
class $OracleTypeConvertersFactory$FromOracleDateToInstant2$Definition
   ...
   private static final Map $TYPE_ARGUMENTS = AnnotationUtil.mapOf(
      ...
      new Argument[]{Argument.ofTypeVariable(DATE.class, "S"), Argument.ofTypeVariable(Instant.class, "T")},
   ...
   public DataTypeConverter build(BeanResolutionContext var1, BeanContext var2, BeanDefinition var3) {
      ...
      DataTypeConverter var5 = ((OracleTypeConvertersFactory)var4).fromOracleDateToInstant();
   ...
   public $OracleTypeConvertersFactory$FromOracleDateToInstant2$Definition() {
      this(DataTypeConverter.class, $CONSTRUCTOR);
   }

   protected $OracleTypeConvertersFactory$FromOracleDateToInstant2$Definition(Class var1, AbstractInitializableBeanDefinition.MethodOrFieldReference var2) {
      super(
         var1,
         var2,
         $OracleTypeConvertersFactory$FromOracleDateToInstant2$Definition$Reference.$ANNOTATION_METADATA,
         null,
         null,
         null,
         null,
