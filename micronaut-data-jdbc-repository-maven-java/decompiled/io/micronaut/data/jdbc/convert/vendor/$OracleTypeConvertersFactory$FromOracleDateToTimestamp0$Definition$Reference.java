...
public final class $OracleTypeConvertersFactory$FromOracleDateToTimestamp0$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $OracleTypeConvertersFactory$FromOracleDateToTimestamp0$Definition$Reference() {
      super(
         "io.micronaut.data.runtime.convert.DataTypeConverter",
         "io.micronaut.data.jdbc.convert.vendor.$OracleTypeConvertersFactory$FromOracleDateToTimestamp0$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $OracleTypeConvertersFactory$FromOracleDateToTimestamp0$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $OracleTypeConvertersFactory$FromOracleDateToTimestamp0$Definition.class;
   }
