...
public final class $OracleTypeConvertersFactory$FromOracleDateToInstant2$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $OracleTypeConvertersFactory$FromOracleDateToInstant2$Definition$Reference() {
      super(
         "io.micronaut.data.runtime.convert.DataTypeConverter",
         "io.micronaut.data.jdbc.convert.vendor.$OracleTypeConvertersFactory$FromOracleDateToInstant2$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $OracleTypeConvertersFactory$FromOracleDateToInstant2$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $OracleTypeConvertersFactory$FromOracleDateToInstant2$Definition.class;
   }
