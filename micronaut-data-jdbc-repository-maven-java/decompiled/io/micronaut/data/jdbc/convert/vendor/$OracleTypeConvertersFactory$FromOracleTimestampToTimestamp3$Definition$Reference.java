...
public final class $OracleTypeConvertersFactory$FromOracleTimestampToTimestamp3$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $OracleTypeConvertersFactory$FromOracleTimestampToTimestamp3$Definition$Reference() {
      super(
         "io.micronaut.data.runtime.convert.DataTypeConverter",
         "io.micronaut.data.jdbc.convert.vendor.$OracleTypeConvertersFactory$FromOracleTimestampToTimestamp3$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $OracleTypeConvertersFactory$FromOracleTimestampToTimestamp3$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $OracleTypeConvertersFactory$FromOracleTimestampToTimestamp3$Definition.class;
   }
