...
// $FF: synthetic class
@Generated
class $OracleTypeConvertersFactory$FromOracleDateToTimestamp0$Definition
   ...
   private static final Map $TYPE_ARGUMENTS = AnnotationUtil.mapOf(
      ...
      new Argument[]{Argument.ofTypeVariable(DATE.class, "S"), Argument.ofTypeVariable(Timestamp.class, "T")},
   ...
   public DataTypeConverter build(BeanResolutionContext var1, BeanContext var2, BeanDefinition var3) {
      ...
      DataTypeConverter var5 = ((OracleTypeConvertersFactory)var4).fromOracleDateToTimestamp();
   ...
   public $OracleTypeConvertersFactory$FromOracleDateToTimestamp0$Definition() {
      this(DataTypeConverter.class, $CONSTRUCTOR);
   }

   protected $OracleTypeConvertersFactory$FromOracleDateToTimestamp0$Definition(Class var1, AbstractInitializableBeanDefinition.MethodOrFieldReference var2) {
      super(
         var1,
         var2,
         $OracleTypeConvertersFactory$FromOracleDateToTimestamp0$Definition$Reference.$ANNOTATION_METADATA,
         null,
         null,
         null,
         null,
