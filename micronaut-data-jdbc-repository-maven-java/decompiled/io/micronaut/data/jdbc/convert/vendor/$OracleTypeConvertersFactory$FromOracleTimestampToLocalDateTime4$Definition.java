...
// $FF: synthetic class
@Generated
class $OracleTypeConvertersFactory$FromOracleTimestampToLocalDateTime4$Definition
   ...
   private static final AbstractInitializableBeanDefinition.MethodOrFieldReference $CONSTRUCTOR = new AbstractInitializableBeanDefinition.MethodReference(
      ...
      "fromOracleTimestampToLocalDateTime",
      null,
   ...
   private static final Map $TYPE_ARGUMENTS = AnnotationUtil.mapOf(
      ...
      new Argument[]{Argument.ofTypeVariable(TIMESTAMP.class, "S"), Argument.ofTypeVariable(LocalDateTime.class, "T")},
   ...
   public DataTypeConverter build(BeanResolutionContext var1, BeanContext var2, BeanDefinition var3) {
      ...
      DataTypeConverter var5 = ((OracleTypeConvertersFactory)var4).fromOracleTimestampToLocalDateTime();
   ...
   public $OracleTypeConvertersFactory$FromOracleTimestampToLocalDateTime4$Definition() {
      this(DataTypeConverter.class, $CONSTRUCTOR);
   }

   protected $OracleTypeConvertersFactory$FromOracleTimestampToLocalDateTime4$Definition(
      Class var1, AbstractInitializableBeanDefinition.MethodOrFieldReference var2
   ) {
      super(
         var1,
         var2,
         $OracleTypeConvertersFactory$FromOracleTimestampToLocalDateTime4$Definition$Reference.$ANNOTATION_METADATA,
         null,
         null,
         null,
         null,
