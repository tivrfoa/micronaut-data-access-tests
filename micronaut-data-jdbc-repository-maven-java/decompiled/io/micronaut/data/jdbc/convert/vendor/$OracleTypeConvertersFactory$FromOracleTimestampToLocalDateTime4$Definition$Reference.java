...
public final class $OracleTypeConvertersFactory$FromOracleTimestampToLocalDateTime4$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $OracleTypeConvertersFactory$FromOracleTimestampToLocalDateTime4$Definition$Reference() {
      super(
         "io.micronaut.data.runtime.convert.DataTypeConverter",
         "io.micronaut.data.jdbc.convert.vendor.$OracleTypeConvertersFactory$FromOracleTimestampToLocalDateTime4$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $OracleTypeConvertersFactory$FromOracleTimestampToLocalDateTime4$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $OracleTypeConvertersFactory$FromOracleTimestampToLocalDateTime4$Definition.class;
   }
