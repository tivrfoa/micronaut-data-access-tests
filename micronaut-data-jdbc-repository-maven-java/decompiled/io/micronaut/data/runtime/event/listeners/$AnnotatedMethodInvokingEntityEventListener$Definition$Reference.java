...
public final class $AnnotatedMethodInvokingEntityEventListener$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $AnnotatedMethodInvokingEntityEventListener$Definition$Reference() {
      super(
         "io.micronaut.data.runtime.event.listeners.AnnotatedMethodInvokingEntityEventListener",
         "io.micronaut.data.runtime.event.listeners.$AnnotatedMethodInvokingEntityEventListener$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $AnnotatedMethodInvokingEntityEventListener$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $AnnotatedMethodInvokingEntityEventListener$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return AnnotatedMethodInvokingEntityEventListener.class;
   }
}
