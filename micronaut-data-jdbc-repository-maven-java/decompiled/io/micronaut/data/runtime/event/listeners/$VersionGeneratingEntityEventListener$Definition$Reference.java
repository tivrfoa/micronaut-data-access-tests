...
public final class $VersionGeneratingEntityEventListener$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $VersionGeneratingEntityEventListener$Definition$Reference() {
      super(
         "io.micronaut.data.runtime.event.listeners.VersionGeneratingEntityEventListener",
         "io.micronaut.data.runtime.event.listeners.$VersionGeneratingEntityEventListener$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $VersionGeneratingEntityEventListener$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $VersionGeneratingEntityEventListener$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return VersionGeneratingEntityEventListener.class;
   }
}
