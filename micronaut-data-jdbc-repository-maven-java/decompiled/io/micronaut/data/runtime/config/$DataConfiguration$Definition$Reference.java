...
public final class $DataConfiguration$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   public static final AnnotationMetadata $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
      AnnotationUtil.mapOf(
         "io.micronaut.context.annotation.ConfigurationProperties",
         AnnotationUtil.mapOf("value", "micronaut.data"),
         "io.micronaut.context.annotation.ConfigurationReader",
         AnnotationUtil.mapOf("prefix", "micronaut.data")
      ),
      AnnotationUtil.mapOf(
         "io.micronaut.context.annotation.ConfigurationReader",
         AnnotationUtil.mapOf("value", "micronaut.data"),
   ...
   public $DataConfiguration$Definition$Reference() {
      super(
         "io.micronaut.data.runtime.config.DataConfiguration",
         "io.micronaut.data.runtime.config.$DataConfiguration$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $DataConfiguration$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $DataConfiguration$Definition.class;
   }
