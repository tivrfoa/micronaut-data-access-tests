...
public final class $PageableRequestArgumentBinder$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $PageableRequestArgumentBinder$Definition$Reference() {
      super(
         "io.micronaut.data.runtime.http.PageableRequestArgumentBinder",
         "io.micronaut.data.runtime.http.$PageableRequestArgumentBinder$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $PageableRequestArgumentBinder$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $PageableRequestArgumentBinder$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return PageableRequestArgumentBinder.class;
   }
}
