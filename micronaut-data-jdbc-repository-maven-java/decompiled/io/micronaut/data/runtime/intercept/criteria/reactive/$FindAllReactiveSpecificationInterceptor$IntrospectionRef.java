...
public final class $FindAllReactiveSpecificationInterceptor$IntrospectionRef extends AbstractBeanIntrospectionReference {
   ...
   public BeanIntrospection load() {
      return new $FindAllReactiveSpecificationInterceptor$Introspection();
   }

   @Override
   public String getName() {
      return "io.micronaut.data.runtime.intercept.criteria.reactive.FindAllReactiveSpecificationInterceptor";
   }

   @Override
   public Class getBeanType() {
      return FindAllReactiveSpecificationInterceptor.class;
   }
