...
public final class $FindPageReactiveSpecificationInterceptor$IntrospectionRef extends AbstractBeanIntrospectionReference {
   ...
   public BeanIntrospection load() {
      return new $FindPageReactiveSpecificationInterceptor$Introspection();
   }

   @Override
   public String getName() {
      return "io.micronaut.data.runtime.intercept.criteria.reactive.FindPageReactiveSpecificationInterceptor";
   }

   @Override
   public Class getBeanType() {
      return FindPageReactiveSpecificationInterceptor.class;
   }
