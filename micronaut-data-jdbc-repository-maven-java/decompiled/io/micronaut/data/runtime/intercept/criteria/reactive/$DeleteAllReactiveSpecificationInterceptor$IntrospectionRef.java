...
public final class $DeleteAllReactiveSpecificationInterceptor$IntrospectionRef extends AbstractBeanIntrospectionReference {
   ...
   public BeanIntrospection load() {
      return new $DeleteAllReactiveSpecificationInterceptor$Introspection();
   }

   @Override
   public String getName() {
      return "io.micronaut.data.runtime.intercept.criteria.reactive.DeleteAllReactiveSpecificationInterceptor";
   }

   @Override
   public Class getBeanType() {
      return DeleteAllReactiveSpecificationInterceptor.class;
   }
