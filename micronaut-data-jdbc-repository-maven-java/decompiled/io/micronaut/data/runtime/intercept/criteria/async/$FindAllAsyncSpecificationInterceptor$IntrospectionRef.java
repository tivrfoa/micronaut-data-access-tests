...
public final class $FindAllAsyncSpecificationInterceptor$IntrospectionRef extends AbstractBeanIntrospectionReference {
   ...
   public BeanIntrospection load() {
      return new $FindAllAsyncSpecificationInterceptor$Introspection();
   }

   @Override
   public String getName() {
      return "io.micronaut.data.runtime.intercept.criteria.async.FindAllAsyncSpecificationInterceptor";
   }

   @Override
   public Class getBeanType() {
      return FindAllAsyncSpecificationInterceptor.class;
   }
