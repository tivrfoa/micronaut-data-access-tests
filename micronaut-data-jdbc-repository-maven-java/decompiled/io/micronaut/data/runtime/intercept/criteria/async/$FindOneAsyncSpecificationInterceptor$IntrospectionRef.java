...
public final class $FindOneAsyncSpecificationInterceptor$IntrospectionRef extends AbstractBeanIntrospectionReference {
   ...
   public BeanIntrospection load() {
      return new $FindOneAsyncSpecificationInterceptor$Introspection();
   }

   @Override
   public String getName() {
      return "io.micronaut.data.runtime.intercept.criteria.async.FindOneAsyncSpecificationInterceptor";
   }

   @Override
   public Class getBeanType() {
      return FindOneAsyncSpecificationInterceptor.class;
   }
