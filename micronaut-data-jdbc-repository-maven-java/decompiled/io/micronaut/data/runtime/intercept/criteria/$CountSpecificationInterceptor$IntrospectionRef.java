...
public final class $CountSpecificationInterceptor$IntrospectionRef extends AbstractBeanIntrospectionReference {
   ...
   public BeanIntrospection load() {
      return new $CountSpecificationInterceptor$Introspection();
   }

   @Override
   public String getName() {
      return "io.micronaut.data.runtime.intercept.criteria.CountSpecificationInterceptor";
   }

   @Override
   public Class getBeanType() {
      return CountSpecificationInterceptor.class;
   }
