...
public final class $FindPageAsyncSpecificationInterceptor$IntrospectionRef extends AbstractBeanIntrospectionReference {
   ...
   public BeanIntrospection load() {
      return new $FindPageAsyncSpecificationInterceptor$Introspection();
   }

   @Override
   public String getName() {
      return "io.micronaut.data.runtime.intercept.criteria.async.FindPageAsyncSpecificationInterceptor";
   }

   @Override
   public Class getBeanType() {
      return FindPageAsyncSpecificationInterceptor.class;
   }
