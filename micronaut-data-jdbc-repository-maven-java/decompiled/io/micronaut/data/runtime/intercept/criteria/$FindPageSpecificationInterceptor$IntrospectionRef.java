...
public final class $FindPageSpecificationInterceptor$IntrospectionRef extends AbstractBeanIntrospectionReference {
   ...
   public BeanIntrospection load() {
      return new $FindPageSpecificationInterceptor$Introspection();
   }

   @Override
   public String getName() {
      return "io.micronaut.data.runtime.intercept.criteria.FindPageSpecificationInterceptor";
   }

   @Override
   public Class getBeanType() {
      return FindPageSpecificationInterceptor.class;
   }
