...
public final class $FindOneSpecificationInterceptor$IntrospectionRef extends AbstractBeanIntrospectionReference {
   ...
   public BeanIntrospection load() {
      return new $FindOneSpecificationInterceptor$Introspection();
   }

   @Override
   public String getName() {
      return "io.micronaut.data.runtime.intercept.criteria.FindOneSpecificationInterceptor";
   }

   @Override
   public Class getBeanType() {
      return FindOneSpecificationInterceptor.class;
   }
