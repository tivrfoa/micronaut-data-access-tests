...
public final class $FindOneReactiveSpecificationInterceptor$IntrospectionRef extends AbstractBeanIntrospectionReference {
   ...
   public BeanIntrospection load() {
      return new $FindOneReactiveSpecificationInterceptor$Introspection();
   }

   @Override
   public String getName() {
      return "io.micronaut.data.runtime.intercept.criteria.reactive.FindOneReactiveSpecificationInterceptor";
   }

   @Override
   public Class getBeanType() {
      return FindOneReactiveSpecificationInterceptor.class;
   }
