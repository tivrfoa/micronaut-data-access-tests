...
public final class $DeleteAllAsyncSpecificationInterceptor$IntrospectionRef extends AbstractBeanIntrospectionReference {
   ...
   public BeanIntrospection load() {
      return new $DeleteAllAsyncSpecificationInterceptor$Introspection();
   }

   @Override
   public String getName() {
      return "io.micronaut.data.runtime.intercept.criteria.async.DeleteAllAsyncSpecificationInterceptor";
   }

   @Override
   public Class getBeanType() {
      return DeleteAllAsyncSpecificationInterceptor.class;
   }
