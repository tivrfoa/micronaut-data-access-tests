...
public final class $DeleteAllSpecificationInterceptor$IntrospectionRef extends AbstractBeanIntrospectionReference {
   ...
   public BeanIntrospection load() {
      return new $DeleteAllSpecificationInterceptor$Introspection();
   }

   @Override
   public String getName() {
      return "io.micronaut.data.runtime.intercept.criteria.DeleteAllSpecificationInterceptor";
   }

   @Override
   public Class getBeanType() {
      return DeleteAllSpecificationInterceptor.class;
   }
