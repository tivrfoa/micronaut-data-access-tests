...
public final class $UpdateAllReactiveSpecificationInterceptor$IntrospectionRef extends AbstractBeanIntrospectionReference {
   ...
   public BeanIntrospection load() {
      return new $UpdateAllReactiveSpecificationInterceptor$Introspection();
   }

   @Override
   public String getName() {
      return "io.micronaut.data.runtime.intercept.criteria.reactive.UpdateAllReactiveSpecificationInterceptor";
   }

   @Override
   public Class getBeanType() {
      return UpdateAllReactiveSpecificationInterceptor.class;
   }
