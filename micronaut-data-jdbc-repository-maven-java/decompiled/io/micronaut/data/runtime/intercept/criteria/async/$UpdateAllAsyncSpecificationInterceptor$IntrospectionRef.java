...
public final class $UpdateAllAsyncSpecificationInterceptor$IntrospectionRef extends AbstractBeanIntrospectionReference {
   ...
   public BeanIntrospection load() {
      return new $UpdateAllAsyncSpecificationInterceptor$Introspection();
   }

   @Override
   public String getName() {
      return "io.micronaut.data.runtime.intercept.criteria.async.UpdateAllAsyncSpecificationInterceptor";
   }

   @Override
   public Class getBeanType() {
      return UpdateAllAsyncSpecificationInterceptor.class;
   }
