...
public final class $UpdateAllSpecificationInterceptor$IntrospectionRef extends AbstractBeanIntrospectionReference {
   ...
   public BeanIntrospection load() {
      return new $UpdateAllSpecificationInterceptor$Introspection();
   }

   @Override
   public String getName() {
      return "io.micronaut.data.runtime.intercept.criteria.UpdateAllSpecificationInterceptor";
   }

   @Override
   public Class getBeanType() {
      return UpdateAllSpecificationInterceptor.class;
   }
