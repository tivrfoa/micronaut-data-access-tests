...
public final class $CountReactiveSpecificationInterceptor$IntrospectionRef extends AbstractBeanIntrospectionReference {
   ...
   public BeanIntrospection load() {
      return new $CountReactiveSpecificationInterceptor$Introspection();
   }

   @Override
   public String getName() {
      return "io.micronaut.data.runtime.intercept.criteria.reactive.CountReactiveSpecificationInterceptor";
   }

   @Override
   public Class getBeanType() {
      return CountReactiveSpecificationInterceptor.class;
   }
