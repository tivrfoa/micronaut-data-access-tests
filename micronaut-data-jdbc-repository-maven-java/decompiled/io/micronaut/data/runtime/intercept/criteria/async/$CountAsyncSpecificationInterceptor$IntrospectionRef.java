...
public final class $CountAsyncSpecificationInterceptor$IntrospectionRef extends AbstractBeanIntrospectionReference {
   ...
   public BeanIntrospection load() {
      return new $CountAsyncSpecificationInterceptor$Introspection();
   }

   @Override
   public String getName() {
      return "io.micronaut.data.runtime.intercept.criteria.async.CountAsyncSpecificationInterceptor";
   }

   @Override
   public Class getBeanType() {
      return CountAsyncSpecificationInterceptor.class;
   }
