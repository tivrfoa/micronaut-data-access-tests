...
public final class $FindAllSpecificationInterceptor$IntrospectionRef extends AbstractBeanIntrospectionReference {
   ...
   public BeanIntrospection load() {
      return new $FindAllSpecificationInterceptor$Introspection();
   }

   @Override
   public String getName() {
      return "io.micronaut.data.runtime.intercept.criteria.FindAllSpecificationInterceptor";
   }

   @Override
   public Class getBeanType() {
      return FindAllSpecificationInterceptor.class;
   }
