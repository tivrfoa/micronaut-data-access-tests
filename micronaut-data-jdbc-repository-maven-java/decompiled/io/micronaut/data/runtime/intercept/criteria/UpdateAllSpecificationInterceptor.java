...
@Internal
public class UpdateAllSpecificationInterceptor extends AbstractSpecificationInterceptor<Object, Object> {
   protected UpdateAllSpecificationInterceptor(RepositoryOperations operations) {
      super(operations);
   }
   ...
   public Object intercept(RepositoryMethodKey methodKey, MethodInvocationContext<Object, Object> context) {
      ...
      Number result = (Number)this.operations.executeUpdate(preparedQuery).orElse(0);
      if (rt.isVoid()) {
         return null;
      } else {
