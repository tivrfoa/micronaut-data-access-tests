...
public final class $DelegatingDataSourceResolver$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $DelegatingDataSourceResolver$Definition$Reference() {
      super(
         "io.micronaut.transaction.jdbc.DelegatingDataSourceResolver",
         "io.micronaut.transaction.jdbc.$DelegatingDataSourceResolver$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $DelegatingDataSourceResolver$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $DelegatingDataSourceResolver$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return DelegatingDataSourceResolver.class;
   }
}
