...
public final class $TransactionAwareDataSource$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  new AnnotationValue(
                     ...
                     AnnotationUtil.mapOf("missingBeans", new AnnotationClassValue[]{$micronaut_load_class_value_4()}),
   ...
   public $TransactionAwareDataSource$Definition$Reference() {
      super(
         "io.micronaut.transaction.jdbc.TransactionAwareDataSource",
         "io.micronaut.transaction.jdbc.$TransactionAwareDataSource$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $TransactionAwareDataSource$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $TransactionAwareDataSource$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return TransactionAwareDataSource.class;
   }
}
