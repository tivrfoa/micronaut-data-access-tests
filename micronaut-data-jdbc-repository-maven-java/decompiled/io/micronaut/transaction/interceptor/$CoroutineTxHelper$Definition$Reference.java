...
public final class $CoroutineTxHelper$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $CoroutineTxHelper$Definition$Reference() {
      super(
         "io.micronaut.transaction.interceptor.CoroutineTxHelper",
         "io.micronaut.transaction.interceptor.$CoroutineTxHelper$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $CoroutineTxHelper$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $CoroutineTxHelper$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return CoroutineTxHelper.class;
   }
}
