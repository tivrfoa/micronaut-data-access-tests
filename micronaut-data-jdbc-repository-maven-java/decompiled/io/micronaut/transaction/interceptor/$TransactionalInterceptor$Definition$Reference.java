...
public final class $TransactionalInterceptor$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $TransactionalInterceptor$Definition$Reference() {
      super(
         "io.micronaut.transaction.interceptor.TransactionalInterceptor",
         "io.micronaut.transaction.interceptor.$TransactionalInterceptor$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $TransactionalInterceptor$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $TransactionalInterceptor$Definition.class;
   }
