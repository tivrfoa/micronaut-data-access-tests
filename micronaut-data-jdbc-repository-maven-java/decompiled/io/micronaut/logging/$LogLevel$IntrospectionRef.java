...
public final class $LogLevel$IntrospectionRef extends AbstractBeanIntrospectionReference {
   ...
   public BeanIntrospection load() {
      return new $LogLevel$Introspection();
   }

   @Override
   public String getName() {
      return "io.micronaut.logging.LogLevel";
   }
