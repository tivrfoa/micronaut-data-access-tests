...
public final class $WriteEndpointRouteBuilder$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $WriteEndpointRouteBuilder$Definition$Reference() {
      super(
         "io.micronaut.management.endpoint.processors.WriteEndpointRouteBuilder",
         "io.micronaut.management.endpoint.processors.$WriteEndpointRouteBuilder$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $WriteEndpointRouteBuilder$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $WriteEndpointRouteBuilder$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return WriteEndpointRouteBuilder.class;
   }
}
