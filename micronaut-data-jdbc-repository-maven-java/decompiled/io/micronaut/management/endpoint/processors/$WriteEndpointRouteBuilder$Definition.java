...
// $FF: synthetic class
@Generated
class $WriteEndpointRouteBuilder$Definition
   extends AbstractInitializableBeanDefinition<WriteEndpointRouteBuilder>
   implements BeanFactory<WriteEndpointRouteBuilder> {
   private static final AbstractInitializableBeanDefinition.MethodOrFieldReference $CONSTRUCTOR = new AbstractInitializableBeanDefinition.MethodReference(
      WriteEndpointRouteBuilder.class,
      "<init>",
      new Argument[]{
   ...
   @Override
   public WriteEndpointRouteBuilder build(BeanResolutionContext var1, BeanContext var2, BeanDefinition var3) {
      WriteEndpointRouteBuilder var4 = new WriteEndpointRouteBuilder(
         var2,
      ...
      return (WriteEndpointRouteBuilder)this.injectBean(var1, var2, var4);
   }

   @Override
   protected Object injectBean(BeanResolutionContext var1, BeanContext var2, Object var3) {
      WriteEndpointRouteBuilder var4 = (WriteEndpointRouteBuilder)var3;
      return super.injectBean(var1, var2, var3);
   }

   public $WriteEndpointRouteBuilder$Definition() {
      this(WriteEndpointRouteBuilder.class, $CONSTRUCTOR);
   }

   protected $WriteEndpointRouteBuilder$Definition(Class var1, AbstractInitializableBeanDefinition.MethodOrFieldReference var2) {
      super(
         var1,
         var2,
         $WriteEndpointRouteBuilder$Definition$Reference.$ANNOTATION_METADATA,
         null,
         null,
         null,
         null,
