...
public final class $ReadEndpointRouteBuilder$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $ReadEndpointRouteBuilder$Definition$Reference() {
      super(
         "io.micronaut.management.endpoint.processors.ReadEndpointRouteBuilder",
         "io.micronaut.management.endpoint.processors.$ReadEndpointRouteBuilder$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $ReadEndpointRouteBuilder$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $ReadEndpointRouteBuilder$Definition.class;
   }
