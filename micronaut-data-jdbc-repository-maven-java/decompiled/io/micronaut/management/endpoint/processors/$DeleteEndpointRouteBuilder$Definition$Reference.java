...
public final class $DeleteEndpointRouteBuilder$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $DeleteEndpointRouteBuilder$Definition$Reference() {
      super(
         "io.micronaut.management.endpoint.processors.DeleteEndpointRouteBuilder",
         "io.micronaut.management.endpoint.processors.$DeleteEndpointRouteBuilder$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $DeleteEndpointRouteBuilder$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $DeleteEndpointRouteBuilder$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return DeleteEndpointRouteBuilder.class;
   }
}
