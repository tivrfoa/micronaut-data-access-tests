...
public final class $DefaultRouteData$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $DefaultRouteData$Definition$Reference() {
      super(
         "io.micronaut.management.endpoint.routes.impl.DefaultRouteData",
         "io.micronaut.management.endpoint.routes.impl.$DefaultRouteData$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $DefaultRouteData$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $DefaultRouteData$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return DefaultRouteData.class;
   }
}
