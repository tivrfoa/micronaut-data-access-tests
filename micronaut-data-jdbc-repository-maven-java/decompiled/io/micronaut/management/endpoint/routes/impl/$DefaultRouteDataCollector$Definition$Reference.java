...
public final class $DefaultRouteDataCollector$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $DefaultRouteDataCollector$Definition$Reference() {
      super(
         "io.micronaut.management.endpoint.routes.impl.DefaultRouteDataCollector",
         "io.micronaut.management.endpoint.routes.impl.$DefaultRouteDataCollector$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $DefaultRouteDataCollector$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $DefaultRouteDataCollector$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return DefaultRouteDataCollector.class;
   }
}
