...
public final class $RoutesEndpoint$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   static {
      ...
      $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf("prefix", "endpoints.endpoints.routes"),
            "io.micronaut.management.endpoint.annotation.Endpoint",
            AnnotationUtil.mapOf("id", "routes", "value", "routes")
         ),
         AnnotationUtil.mapOf(
            "io.micronaut.context.annotation.ConfigurationReader",
            AnnotationUtil.mapOf("prefix", "endpoints", "value", "routes"),
   ...
   public $RoutesEndpoint$Definition$Reference() {
      super(
         "io.micronaut.management.endpoint.routes.RoutesEndpoint",
         "io.micronaut.management.endpoint.routes.$RoutesEndpoint$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $RoutesEndpoint$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $RoutesEndpoint$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return RoutesEndpoint.class;
   }
}
