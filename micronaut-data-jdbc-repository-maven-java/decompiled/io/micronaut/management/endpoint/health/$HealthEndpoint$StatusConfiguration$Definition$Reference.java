...
public final class $HealthEndpoint$StatusConfiguration$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   public static final AnnotationMetadata $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
      AnnotationUtil.mapOf(
         "io.micronaut.context.annotation.ConfigurationProperties",
         AnnotationUtil.mapOf("value", "status"),
         "io.micronaut.context.annotation.ConfigurationReader",
         AnnotationUtil.mapOf("prefix", "endpoints.health.status")
      ),
      AnnotationUtil.mapOf(
         "io.micronaut.context.annotation.ConfigurationReader",
         AnnotationUtil.mapOf("value", "status"),
   ...
   public $HealthEndpoint$StatusConfiguration$Definition$Reference() {
      super(
         "io.micronaut.management.endpoint.health.HealthEndpoint$StatusConfiguration",
         "io.micronaut.management.endpoint.health.$HealthEndpoint$StatusConfiguration$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $HealthEndpoint$StatusConfiguration$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $HealthEndpoint$StatusConfiguration$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return HealthEndpoint.StatusConfiguration.class;
   }
}
