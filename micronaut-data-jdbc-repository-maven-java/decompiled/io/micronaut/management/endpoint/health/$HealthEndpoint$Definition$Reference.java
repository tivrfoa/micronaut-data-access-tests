...
public final class $HealthEndpoint$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $HealthEndpoint$Definition$Reference() {
      super(
   ...
   public BeanDefinition load() {
      return new $HealthEndpoint$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $HealthEndpoint$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return HealthEndpoint.class;
   }
}
