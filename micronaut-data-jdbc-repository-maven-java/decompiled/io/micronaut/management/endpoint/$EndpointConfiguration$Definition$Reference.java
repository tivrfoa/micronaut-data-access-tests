...
public final class $EndpointConfiguration$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   public static final AnnotationMetadata $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
      AnnotationUtil.mapOf(
         "io.micronaut.context.annotation.ConfigurationReader",
         AnnotationUtil.mapOf("prefix", "endpoints.*"),
         "io.micronaut.context.annotation.EachProperty",
         AnnotationUtil.mapOf("value", "endpoints")
      ),
      AnnotationUtil.mapOf(
         "io.micronaut.context.annotation.ConfigurationReader",
         AnnotationUtil.mapOf("value", "endpoints"),
   ...
   public $EndpointConfiguration$Definition$Reference() {
      super(
         "io.micronaut.management.endpoint.EndpointConfiguration",
         "io.micronaut.management.endpoint.$EndpointConfiguration$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $EndpointConfiguration$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $EndpointConfiguration$Definition.class;
   }
