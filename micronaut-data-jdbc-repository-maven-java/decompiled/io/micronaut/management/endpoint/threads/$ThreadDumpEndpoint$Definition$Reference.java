...
public final class $ThreadDumpEndpoint$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   static {
      ...
      $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf("prefix", "endpoints.endpoints.threaddump"),
            "io.micronaut.management.endpoint.annotation.Endpoint",
            AnnotationUtil.mapOf("id", "threaddump", "value", "threaddump")
         ),
         AnnotationUtil.mapOf(
            "io.micronaut.context.annotation.ConfigurationReader",
            AnnotationUtil.mapOf("prefix", "endpoints", "value", "threaddump"),
   ...
   public $ThreadDumpEndpoint$Definition$Reference() {
      super(
         "io.micronaut.management.endpoint.threads.ThreadDumpEndpoint",
         "io.micronaut.management.endpoint.threads.$ThreadDumpEndpoint$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $ThreadDumpEndpoint$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $ThreadDumpEndpoint$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return ThreadDumpEndpoint.class;
   }
}
