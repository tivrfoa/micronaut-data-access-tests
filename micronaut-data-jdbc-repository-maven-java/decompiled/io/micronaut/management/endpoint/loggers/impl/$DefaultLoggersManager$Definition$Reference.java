...
public final class $DefaultLoggersManager$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $DefaultLoggersManager$Definition$Reference() {
      super(
         "io.micronaut.management.endpoint.loggers.impl.DefaultLoggersManager",
         "io.micronaut.management.endpoint.loggers.impl.$DefaultLoggersManager$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $DefaultLoggersManager$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $DefaultLoggersManager$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return DefaultLoggersManager.class;
   }
}
