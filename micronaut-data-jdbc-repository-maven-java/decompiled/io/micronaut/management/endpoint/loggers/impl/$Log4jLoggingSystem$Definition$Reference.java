...
public final class $Log4jLoggingSystem$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   static {
      ...
      $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf("bean", $micronaut_load_class_value_5(), "value", $micronaut_load_class_value_5()),
   ...
   public $Log4jLoggingSystem$Definition$Reference() {
      super(
         "io.micronaut.management.endpoint.loggers.impl.Log4jLoggingSystem",
         "io.micronaut.management.endpoint.loggers.impl.$Log4jLoggingSystem$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $Log4jLoggingSystem$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $Log4jLoggingSystem$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return Log4jLoggingSystem.class;
   }
}
