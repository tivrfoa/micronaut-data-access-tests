...
public final class $RefreshEndpoint$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   static {
      ...
      $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf("prefix", "endpoints.endpoints.refresh"),
            "io.micronaut.management.endpoint.annotation.Endpoint",
            AnnotationUtil.mapOf("id", "refresh", "value", "refresh")
         ),
         AnnotationUtil.mapOf(
            "io.micronaut.context.annotation.ConfigurationReader",
            AnnotationUtil.mapOf("prefix", "endpoints", "value", "refresh"),
   ...
   public $RefreshEndpoint$Definition$Reference() {
      super(
         "io.micronaut.management.endpoint.refresh.RefreshEndpoint",
         "io.micronaut.management.endpoint.refresh.$RefreshEndpoint$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $RefreshEndpoint$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $RefreshEndpoint$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return RefreshEndpoint.class;
   }
}
