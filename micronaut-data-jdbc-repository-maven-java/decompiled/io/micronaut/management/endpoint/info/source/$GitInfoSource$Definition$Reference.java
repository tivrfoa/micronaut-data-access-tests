...
public final class $GitInfoSource$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
         ...
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  ...
                  new AnnotationValue(
                     "io.micronaut.context.annotation.Requires", AnnotationUtil.mapOf("notEquals", "false", "property", "endpoints.info.git.enabled"), var0
                  )
               }
            ),
   ...
   public $GitInfoSource$Definition$Reference() {
      super(
         "io.micronaut.management.endpoint.info.source.GitInfoSource",
         "io.micronaut.management.endpoint.info.source.$GitInfoSource$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $GitInfoSource$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $GitInfoSource$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return GitInfoSource.class;
   }
}
