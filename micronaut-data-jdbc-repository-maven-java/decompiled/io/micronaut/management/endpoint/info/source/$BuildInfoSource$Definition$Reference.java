...
public final class $BuildInfoSource$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
         ...
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  ...
                  new AnnotationValue(
                     "io.micronaut.context.annotation.Requires", AnnotationUtil.mapOf("notEquals", "false", "property", "endpoints.info.build.enabled"), var0
                  )
               }
            ),
   ...
   public $BuildInfoSource$Definition$Reference() {
      super(
         "io.micronaut.management.endpoint.info.source.BuildInfoSource",
         "io.micronaut.management.endpoint.info.source.$BuildInfoSource$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $BuildInfoSource$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $BuildInfoSource$Definition.class;
   }
