...
public final class $ConfigurationInfoSource$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $ConfigurationInfoSource$Definition$Reference() {
      super(
         "io.micronaut.management.endpoint.info.source.ConfigurationInfoSource",
         "io.micronaut.management.endpoint.info.source.$ConfigurationInfoSource$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $ConfigurationInfoSource$Definition();
   }
