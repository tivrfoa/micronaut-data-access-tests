...
public final class $InfoEndpoint$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   static {
      ...
      $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf("prefix", "endpoints.endpoints.info"),
            "io.micronaut.management.endpoint.annotation.Endpoint",
            AnnotationUtil.mapOf("id", "info", "value", "info")
         ),
         AnnotationUtil.mapOf(
            "io.micronaut.context.annotation.ConfigurationReader",
            AnnotationUtil.mapOf("prefix", "endpoints", "value", "info"),
   ...
   public $InfoEndpoint$Definition$Reference() {
      super(
         "io.micronaut.management.endpoint.info.InfoEndpoint",
         "io.micronaut.management.endpoint.info.$InfoEndpoint$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $InfoEndpoint$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $InfoEndpoint$Definition.class;
   }
