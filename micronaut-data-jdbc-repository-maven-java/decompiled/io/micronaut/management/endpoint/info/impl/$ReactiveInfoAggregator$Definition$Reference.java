...
public final class $ReactiveInfoAggregator$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $ReactiveInfoAggregator$Definition$Reference() {
      super(
         "io.micronaut.management.endpoint.info.impl.ReactiveInfoAggregator",
         "io.micronaut.management.endpoint.info.impl.$ReactiveInfoAggregator$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $ReactiveInfoAggregator$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $ReactiveInfoAggregator$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return ReactiveInfoAggregator.class;
   }
}
