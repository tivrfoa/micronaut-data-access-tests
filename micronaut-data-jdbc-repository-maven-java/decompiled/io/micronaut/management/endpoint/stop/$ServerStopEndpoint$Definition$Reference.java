...
public final class $ServerStopEndpoint$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   static {
      ...
      DefaultAnnotationMetadata.registerAnnotationDefaults(
         $micronaut_load_class_value_4(), AnnotationUtil.mapOf("consumes", new String[]{"application/json"}, "produces", new String[]{"application/json"})
      );
      DefaultAnnotationMetadata.registerAnnotationDefaults(
         $micronaut_load_class_value_5(), AnnotationUtil.mapOf("single", false, "value", new String[]{"application/json"})
      );
      ...
      $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf("prefix", "endpoints.endpoints.stop"),
            "io.micronaut.management.endpoint.annotation.Endpoint",
            AnnotationUtil.mapOf("defaultEnabled", false, "id", "stop", "value", "stop")
         ),
         AnnotationUtil.mapOf(
            "io.micronaut.context.annotation.ConfigurationReader",
            AnnotationUtil.mapOf("prefix", "endpoints", "value", "stop"),
   ...
   public $ServerStopEndpoint$Definition$Reference() {
      super(
         "io.micronaut.management.endpoint.stop.ServerStopEndpoint",
         "io.micronaut.management.endpoint.stop.$ServerStopEndpoint$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $ServerStopEndpoint$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $ServerStopEndpoint$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return ServerStopEndpoint.class;
   }
}
