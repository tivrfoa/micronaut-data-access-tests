...
public final class $DefaultBeanDefinitionDataCollector$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $DefaultBeanDefinitionDataCollector$Definition$Reference() {
      super(
         "io.micronaut.management.endpoint.beans.impl.DefaultBeanDefinitionDataCollector",
         "io.micronaut.management.endpoint.beans.impl.$DefaultBeanDefinitionDataCollector$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $DefaultBeanDefinitionDataCollector$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $DefaultBeanDefinitionDataCollector$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return DefaultBeanDefinitionDataCollector.class;
   }
}
