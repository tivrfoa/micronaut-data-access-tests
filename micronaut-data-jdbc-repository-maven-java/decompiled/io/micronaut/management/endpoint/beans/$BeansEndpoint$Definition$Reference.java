...
public final class $BeansEndpoint$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   static {
      ...
      $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf("prefix", "endpoints.endpoints.beans"),
            "io.micronaut.management.endpoint.annotation.Endpoint",
            AnnotationUtil.mapOf("id", "beans", "value", "beans")
         ),
         AnnotationUtil.mapOf(
            "io.micronaut.context.annotation.ConfigurationReader",
            AnnotationUtil.mapOf("prefix", "endpoints", "value", "beans"),
   ...
   public $BeansEndpoint$Definition$Reference() {
      super(
         "io.micronaut.management.endpoint.beans.BeansEndpoint",
         "io.micronaut.management.endpoint.beans.$BeansEndpoint$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $BeansEndpoint$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $BeansEndpoint$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return BeansEndpoint.class;
   }
}
