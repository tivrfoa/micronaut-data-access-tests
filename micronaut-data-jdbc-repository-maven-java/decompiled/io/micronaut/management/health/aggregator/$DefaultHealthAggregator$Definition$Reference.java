...
public final class $DefaultHealthAggregator$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $DefaultHealthAggregator$Definition$Reference() {
      super(
         "io.micronaut.management.health.aggregator.DefaultHealthAggregator",
         "io.micronaut.management.health.aggregator.$DefaultHealthAggregator$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $DefaultHealthAggregator$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $DefaultHealthAggregator$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return DefaultHealthAggregator.class;
   }
}
