...
// $FF: synthetic class
@Generated
class ServiceReadyHealthIndicator$ApplicationEventListener$onServiceStarted1$Intercepted implements ApplicationEventListener, Introduced {
   ...
   public ServiceReadyHealthIndicator$ApplicationEventListener$onServiceStarted1$Intercepted(
      BeanResolutionContext var1, BeanContext var2, Qualifier var3, List var4
   ) {
      this.$interceptors = new Interceptor[1][];
      $ServiceReadyHealthIndicator$ApplicationEventListener$onServiceStarted1$Intercepted$Definition$Exec var5 = new $ServiceReadyHealthIndicator$ApplicationEventListener$onServiceStarted1$Intercepted$Definition$Exec(
