...
public final class $ServiceReadyHealthIndicator$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  new AnnotationValue(
                     ...
                     AnnotationUtil.mapOf("beans", new AnnotationClassValue[]{$micronaut_load_class_value_9()}),
   ...
   public $ServiceReadyHealthIndicator$Definition$Reference() {
      super(
         "io.micronaut.management.health.indicator.service.ServiceReadyHealthIndicator",
         "io.micronaut.management.health.indicator.service.$ServiceReadyHealthIndicator$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $ServiceReadyHealthIndicator$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $ServiceReadyHealthIndicator$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return ServiceReadyHealthIndicator.class;
   }
}
