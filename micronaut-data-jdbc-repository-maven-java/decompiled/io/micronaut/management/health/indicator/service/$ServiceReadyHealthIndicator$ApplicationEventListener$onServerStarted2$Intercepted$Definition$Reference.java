...
public final class $ServiceReadyHealthIndicator$ApplicationEventListener$onServerStarted2$Intercepted$Definition$Reference
   ...
   public $ServiceReadyHealthIndicator$ApplicationEventListener$onServerStarted2$Intercepted$Definition$Reference() {
      super(
         ...
         "io.micronaut.management.health.indicator.service.$ServiceReadyHealthIndicator$ApplicationEventListener$onServerStarted2$Intercepted$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $ServiceReadyHealthIndicator$ApplicationEventListener$onServerStarted2$Intercepted$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $ServiceReadyHealthIndicator$ApplicationEventListener$onServerStarted2$Intercepted$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return ServiceReadyHealthIndicator$ApplicationEventListener$onServerStarted2$Intercepted.class;
   }
}
