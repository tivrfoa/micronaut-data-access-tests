...
public final class $JdbcIndicator$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
         ...
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  ...
                  new AnnotationValue(
                     "io.micronaut.context.annotation.Requires", AnnotationUtil.mapOf("notEquals", "false", "property", "endpoints.health.jdbc.enabled"), var0
                  ),
                  new AnnotationValue(
                     "io.micronaut.context.annotation.Requires",
   ...
   public $JdbcIndicator$Definition$Reference() {
      super(
         "io.micronaut.management.health.indicator.jdbc.JdbcIndicator",
         "io.micronaut.management.health.indicator.jdbc.$JdbcIndicator$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $JdbcIndicator$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $JdbcIndicator$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return JdbcIndicator.class;
   }
}
