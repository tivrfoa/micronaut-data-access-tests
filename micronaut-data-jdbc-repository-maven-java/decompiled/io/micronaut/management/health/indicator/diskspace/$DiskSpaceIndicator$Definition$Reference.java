...
public final class $DiskSpaceIndicator$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $DiskSpaceIndicator$Definition$Reference() {
      super(
         "io.micronaut.management.health.indicator.diskspace.DiskSpaceIndicator",
         "io.micronaut.management.health.indicator.diskspace.$DiskSpaceIndicator$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $DiskSpaceIndicator$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $DiskSpaceIndicator$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return DiskSpaceIndicator.class;
   }
}
