...
public final class $DiskSpaceIndicatorConfiguration$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   public static final AnnotationMetadata $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
      AnnotationUtil.mapOf(
         "io.micronaut.context.annotation.ConfigurationProperties",
         AnnotationUtil.mapOf("value", "endpoints.health.disk-space"),
         "io.micronaut.context.annotation.ConfigurationReader",
         AnnotationUtil.mapOf("prefix", "endpoints.health.disk-space")
      ),
      AnnotationUtil.mapOf(
         "io.micronaut.context.annotation.ConfigurationReader",
         AnnotationUtil.mapOf("value", "endpoints.health.disk-space"),
   ...
   public $DiskSpaceIndicatorConfiguration$Definition$Reference() {
      super(
         "io.micronaut.management.health.indicator.diskspace.DiskSpaceIndicatorConfiguration",
         "io.micronaut.management.health.indicator.diskspace.$DiskSpaceIndicatorConfiguration$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $DiskSpaceIndicatorConfiguration$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $DiskSpaceIndicatorConfiguration$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return DiskSpaceIndicatorConfiguration.class;
   }
}
