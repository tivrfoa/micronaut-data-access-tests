...
public final class $DiscoveryClientHealthIndicatorConfiguration$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   static {
      ...
      $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf("value", "endpoints.health.discovery-client"),
            "io.micronaut.context.annotation.ConfigurationReader",
            AnnotationUtil.mapOf("prefix", "endpoints.health.discovery-client"),
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  new AnnotationValue(
                     ...
                     AnnotationUtil.mapOf("notEquals", "false", "property", "endpoints.health.discovery-client.enabled"),
   ...
   public $DiscoveryClientHealthIndicatorConfiguration$Definition$Reference() {
      super(
         "io.micronaut.management.health.indicator.discovery.DiscoveryClientHealthIndicatorConfiguration",
         "io.micronaut.management.health.indicator.discovery.$DiscoveryClientHealthIndicatorConfiguration$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $DiscoveryClientHealthIndicatorConfiguration$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $DiscoveryClientHealthIndicatorConfiguration$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return DiscoveryClientHealthIndicatorConfiguration.class;
   }
}
