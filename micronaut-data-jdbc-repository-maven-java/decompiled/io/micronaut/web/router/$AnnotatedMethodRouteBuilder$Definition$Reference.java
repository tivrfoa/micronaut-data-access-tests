...
public final class $AnnotatedMethodRouteBuilder$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $AnnotatedMethodRouteBuilder$Definition$Reference() {
      super(
         "io.micronaut.web.router.AnnotatedMethodRouteBuilder",
         "io.micronaut.web.router.$AnnotatedMethodRouteBuilder$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $AnnotatedMethodRouteBuilder$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $AnnotatedMethodRouteBuilder$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return AnnotatedMethodRouteBuilder.class;
   }
}
