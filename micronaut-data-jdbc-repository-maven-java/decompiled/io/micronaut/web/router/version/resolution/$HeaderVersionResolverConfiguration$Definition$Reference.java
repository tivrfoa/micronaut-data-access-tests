...
public final class $HeaderVersionResolverConfiguration$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   static {
      ...
      $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf("value", "micronaut.router.versioning.header"),
            "io.micronaut.context.annotation.ConfigurationReader",
            AnnotationUtil.mapOf("prefix", "micronaut.router.versioning.header"),
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  new AnnotationValue(
                     ...
                     AnnotationUtil.mapOf("property", "micronaut.router.versioning.header.enabled", "value", "true"),
   ...
   public $HeaderVersionResolverConfiguration$Definition$Reference() {
      super(
         "io.micronaut.web.router.version.resolution.HeaderVersionResolverConfiguration",
         "io.micronaut.web.router.version.resolution.$HeaderVersionResolverConfiguration$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $HeaderVersionResolverConfiguration$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $HeaderVersionResolverConfiguration$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return HeaderVersionResolverConfiguration.class;
   }
}
