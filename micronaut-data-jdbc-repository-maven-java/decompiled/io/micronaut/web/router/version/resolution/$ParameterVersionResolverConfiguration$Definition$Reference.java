...
public final class $ParameterVersionResolverConfiguration$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   static {
      ...
      $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf("value", "micronaut.router.versioning.parameter"),
            "io.micronaut.context.annotation.ConfigurationReader",
            AnnotationUtil.mapOf("prefix", "micronaut.router.versioning.parameter"),
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  new AnnotationValue(
                     ...
                     AnnotationUtil.mapOf("property", "micronaut.router.versioning.parameter.enabled", "value", "true"),
   ...
   public $ParameterVersionResolverConfiguration$Definition$Reference() {
      super(
         "io.micronaut.web.router.version.resolution.ParameterVersionResolverConfiguration",
         "io.micronaut.web.router.version.resolution.$ParameterVersionResolverConfiguration$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $ParameterVersionResolverConfiguration$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $ParameterVersionResolverConfiguration$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return ParameterVersionResolverConfiguration.class;
   }
}
