...
public final class $VersionAwareRouterListener$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $VersionAwareRouterListener$Definition$Reference() {
      super(
         "io.micronaut.web.router.version.VersionAwareRouterListener",
         "io.micronaut.web.router.version.$VersionAwareRouterListener$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $VersionAwareRouterListener$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $VersionAwareRouterListener$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return VersionAwareRouterListener.class;
   }
}
