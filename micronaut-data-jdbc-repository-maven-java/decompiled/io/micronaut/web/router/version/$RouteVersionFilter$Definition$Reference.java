...
public final class $RouteVersionFilter$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $RouteVersionFilter$Definition$Reference() {
      super(
         "io.micronaut.web.router.version.RouteVersionFilter",
         "io.micronaut.web.router.version.$RouteVersionFilter$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $RouteVersionFilter$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $RouteVersionFilter$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return RouteVersionFilter.class;
   }
}
