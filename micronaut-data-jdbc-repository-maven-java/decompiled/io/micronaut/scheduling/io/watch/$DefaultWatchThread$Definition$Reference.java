...
public final class $DefaultWatchThread$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   static {
      ...
      DefaultAnnotationMetadata.registerAnnotationDefaults($micronaut_load_class_value_2(), AnnotationUtil.mapOf("shutdownOnError", true));
      Map var0;
         ...
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  ...
                  new AnnotationValue("io.micronaut.context.annotation.Requires", AnnotationUtil.mapOf("notEnv", new String[]{"function", "android"}), var0),
                  new AnnotationValue(
                     "io.micronaut.context.annotation.Requires",
                     AnnotationUtil.mapOf("beans", new AnnotationClassValue[]{$micronaut_load_class_value_3()}),
                     var0
                  )
               }
            ),
   ...
   public $DefaultWatchThread$Definition$Reference() {
      super(
         "io.micronaut.scheduling.io.watch.DefaultWatchThread",
         "io.micronaut.scheduling.io.watch.$DefaultWatchThread$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $DefaultWatchThread$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $DefaultWatchThread$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return DefaultWatchThread.class;
   }
}
