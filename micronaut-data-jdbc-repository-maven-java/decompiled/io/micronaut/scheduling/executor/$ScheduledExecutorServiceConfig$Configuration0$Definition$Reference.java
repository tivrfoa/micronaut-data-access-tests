...
public final class $ScheduledExecutorServiceConfig$Configuration0$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $ScheduledExecutorServiceConfig$Configuration0$Definition$Reference() {
      super(
         "io.micronaut.scheduling.executor.ExecutorConfiguration",
         "io.micronaut.scheduling.executor.$ScheduledExecutorServiceConfig$Configuration0$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $ScheduledExecutorServiceConfig$Configuration0$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $ScheduledExecutorServiceConfig$Configuration0$Definition.class;
   }
