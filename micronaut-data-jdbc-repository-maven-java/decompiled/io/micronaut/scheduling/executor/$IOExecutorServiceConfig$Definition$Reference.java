...
public final class $IOExecutorServiceConfig$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $IOExecutorServiceConfig$Definition$Reference() {
      super(
         "io.micronaut.scheduling.executor.IOExecutorServiceConfig",
         "io.micronaut.scheduling.executor.$IOExecutorServiceConfig$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $IOExecutorServiceConfig$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $IOExecutorServiceConfig$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return IOExecutorServiceConfig.class;
   }
}
