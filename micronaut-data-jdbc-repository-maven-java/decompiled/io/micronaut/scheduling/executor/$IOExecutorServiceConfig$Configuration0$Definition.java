...
// $FF: synthetic class
@Generated
class $IOExecutorServiceConfig$Configuration0$Definition
   ...
   public ExecutorConfiguration build(BeanResolutionContext var1, BeanContext var2, BeanDefinition var3) {
      Object var4 = ((DefaultBeanContext)var2).getBean(var1, IOExecutorServiceConfig.class, null);
      var1.markDependentAsFactory();
      ExecutorConfiguration var5 = ((IOExecutorServiceConfig)var4).configuration();
   ...
   public $IOExecutorServiceConfig$Configuration0$Definition() {
      this(ExecutorConfiguration.class, $CONSTRUCTOR);
   }

   protected $IOExecutorServiceConfig$Configuration0$Definition(Class var1, AbstractInitializableBeanDefinition.MethodOrFieldReference var2) {
      super(
         var1,
         var2,
         $IOExecutorServiceConfig$Configuration0$Definition$Reference.$ANNOTATION_METADATA,
         null,
         null,
         null,
         null,
