...
public final class $ExecutorFactory$ExecutorService1$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $ExecutorFactory$ExecutorService1$Definition$Reference() {
      super(
         "java.util.concurrent.ExecutorService",
         "io.micronaut.scheduling.executor.$ExecutorFactory$ExecutorService1$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $ExecutorFactory$ExecutorService1$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $ExecutorFactory$ExecutorService1$Definition.class;
   }
