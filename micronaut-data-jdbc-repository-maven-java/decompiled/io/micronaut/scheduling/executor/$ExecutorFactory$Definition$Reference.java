...
public final class $ExecutorFactory$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $ExecutorFactory$Definition$Reference() {
      super(
         "io.micronaut.scheduling.executor.ExecutorFactory",
         "io.micronaut.scheduling.executor.$ExecutorFactory$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $ExecutorFactory$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $ExecutorFactory$Definition.class;
   }
