...
public final class $RecoveryInterceptor$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $RecoveryInterceptor$Definition$Reference() {
      super(
         "io.micronaut.retry.intercept.RecoveryInterceptor",
         "io.micronaut.retry.intercept.$RecoveryInterceptor$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $RecoveryInterceptor$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $RecoveryInterceptor$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return RecoveryInterceptor.class;
   }
}
