...
public final class $FlywayMigrator$Definition$Intercepted$Definition$Reference extends AbstractInitializableBeanDefinitionReference implements AdvisedBeanType {
   ...
   public $FlywayMigrator$Definition$Intercepted$Definition$Reference() {
      super(
         "io.micronaut.flyway.$FlywayMigrator$Definition$Intercepted",
         "io.micronaut.flyway.$FlywayMigrator$Definition$Intercepted$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $FlywayMigrator$Definition$Intercepted$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $FlywayMigrator$Definition$Intercepted$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return $FlywayMigrator$Definition$Intercepted.class;
   }
