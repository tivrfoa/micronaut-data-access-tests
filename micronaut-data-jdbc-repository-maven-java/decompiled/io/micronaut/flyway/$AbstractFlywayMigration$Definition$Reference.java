...
public final class $AbstractFlywayMigration$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $AbstractFlywayMigration$Definition$Reference() {
      super(
         "io.micronaut.flyway.AbstractFlywayMigration",
         "io.micronaut.flyway.$AbstractFlywayMigration$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $AbstractFlywayMigration$Definition();
   }
