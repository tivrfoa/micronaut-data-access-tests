...
public final class $FlywayEndpoint$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   static {
      ...
      $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf("prefix", "endpoints.endpoints.flyway"),
            "io.micronaut.management.endpoint.annotation.Endpoint",
            AnnotationUtil.mapOf("id", "flyway", "value", "flyway")
         ),
         AnnotationUtil.mapOf(
            "io.micronaut.context.annotation.ConfigurationReader",
            AnnotationUtil.mapOf("prefix", "endpoints", "value", "flyway"),
   ...
   public $FlywayEndpoint$Definition$Reference() {
      super(
         "io.micronaut.flyway.endpoint.FlywayEndpoint",
         "io.micronaut.flyway.endpoint.$FlywayEndpoint$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $FlywayEndpoint$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $FlywayEndpoint$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return FlywayEndpoint.class;
   }
}
