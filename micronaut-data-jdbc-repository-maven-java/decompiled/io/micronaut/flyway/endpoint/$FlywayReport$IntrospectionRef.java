...
public final class $FlywayReport$IntrospectionRef extends AbstractBeanIntrospectionReference {
   ...
   public BeanIntrospection load() {
      return new $FlywayReport$Introspection();
   }

   @Override
   public String getName() {
      return "io.micronaut.flyway.endpoint.FlywayReport";
   }

   @Override
   public Class getBeanType() {
      return FlywayReport.class;
   }
