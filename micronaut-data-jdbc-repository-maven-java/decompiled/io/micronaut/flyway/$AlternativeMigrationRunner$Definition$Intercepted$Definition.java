...
// $FF: synthetic class
@Generated
class $AlternativeMigrationRunner$Definition$Intercepted$Definition
   extends $AlternativeMigrationRunner$Definition
   implements AdvisedBeanType<AlternativeMigrationRunner>,
   BeanFactory<$AlternativeMigrationRunner$Definition$Intercepted>,
   ProxyBeanDefinition<AlternativeMigrationRunner> {
   private static final AbstractInitializableBeanDefinition.MethodOrFieldReference $CONSTRUCTOR;

   @Override
   public $AlternativeMigrationRunner$Definition$Intercepted build(BeanResolutionContext var1, BeanContext var2, BeanDefinition var3) {
      $AlternativeMigrationRunner$Definition$Intercepted var4 = new $AlternativeMigrationRunner$Definition$Intercepted(
         var2,
      ...
      return ($AlternativeMigrationRunner$Definition$Intercepted)this.injectBean(var1, var2, var4);
   }

   @Override
   public Class getTargetDefinitionType() {
      return $AlternativeMigrationRunner$Definition.class;
   }
   ...
   static {
      ...
      $CONSTRUCTOR = new AbstractInitializableBeanDefinition.MethodReference(
         $AlternativeMigrationRunner$Definition$Intercepted.class,
         "<init>",
         new Argument[]{
   ...
   public $AlternativeMigrationRunner$Definition$Intercepted$Definition() {
      super($AlternativeMigrationRunner$Definition$Intercepted.class, $CONSTRUCTOR);
   }
