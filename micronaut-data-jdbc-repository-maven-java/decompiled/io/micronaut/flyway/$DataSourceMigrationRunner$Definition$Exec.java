...
// $FF: synthetic class
@Generated
final class $DataSourceMigrationRunner$Definition$Exec extends AbstractExecutableMethodsDefinition {
   ...
   public $DataSourceMigrationRunner$Definition$Exec() {
      this(false);
   }

   public $DataSourceMigrationRunner$Definition$Exec(boolean var1) {
   ...
   protected final Object dispatch(int var1, Object var2, Object[] var3) {
      switch(var1) {
         case 0:
            if (this.$interceptable && var2 instanceof $DataSourceMigrationRunner$Definition$Intercepted) {
               (($DataSourceMigrationRunner$Definition$Intercepted)var2).$$access$$runAsync((FlywayConfigurationProperties)var3[0], (Flyway)var3[1]);
               return null;
            }
