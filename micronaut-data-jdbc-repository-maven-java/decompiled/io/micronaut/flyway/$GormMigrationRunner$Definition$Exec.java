...
// $FF: synthetic class
@Generated
final class $GormMigrationRunner$Definition$Exec extends AbstractExecutableMethodsDefinition {
   ...
   public $GormMigrationRunner$Definition$Exec() {
      this(false);
   }

   public $GormMigrationRunner$Definition$Exec(boolean var1) {
   ...
   protected final Object dispatch(int var1, Object var2, Object[] var3) {
      switch(var1) {
         case 0:
            if (this.$interceptable && var2 instanceof $GormMigrationRunner$Definition$Intercepted) {
               (($GormMigrationRunner$Definition$Intercepted)var2).$$access$$runAsync((FlywayConfigurationProperties)var3[0], (Flyway)var3[1]);
               return null;
            }
