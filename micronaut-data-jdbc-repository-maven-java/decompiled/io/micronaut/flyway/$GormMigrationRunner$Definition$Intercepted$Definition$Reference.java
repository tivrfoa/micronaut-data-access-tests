...
public final class $GormMigrationRunner$Definition$Intercepted$Definition$Reference
   ...
   public $GormMigrationRunner$Definition$Intercepted$Definition$Reference() {
      super(
         "io.micronaut.flyway.$GormMigrationRunner$Definition$Intercepted",
         "io.micronaut.flyway.$GormMigrationRunner$Definition$Intercepted$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         true,
   ...
   public BeanDefinition load() {
      return new $GormMigrationRunner$Definition$Intercepted$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $GormMigrationRunner$Definition$Intercepted$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return $GormMigrationRunner$Definition$Intercepted.class;
   }
