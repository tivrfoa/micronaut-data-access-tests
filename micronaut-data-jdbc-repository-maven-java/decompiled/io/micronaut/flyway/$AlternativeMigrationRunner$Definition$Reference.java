...
public final class $AlternativeMigrationRunner$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $AlternativeMigrationRunner$Definition$Reference() {
      super(
         "io.micronaut.flyway.AlternativeMigrationRunner",
         "io.micronaut.flyway.$AlternativeMigrationRunner$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $AlternativeMigrationRunner$Definition();
   }
