...
// $FF: synthetic class
@Generated
final class $AlternativeMigrationRunner$Definition$Exec extends AbstractExecutableMethodsDefinition {
   ...
   public $AlternativeMigrationRunner$Definition$Exec() {
      this(false);
   }

   public $AlternativeMigrationRunner$Definition$Exec(boolean var1) {
   ...
   protected final Object dispatch(int var1, Object var2, Object[] var3) {
      switch(var1) {
         case 0:
            if (this.$interceptable && var2 instanceof $AlternativeMigrationRunner$Definition$Intercepted) {
               (($AlternativeMigrationRunner$Definition$Intercepted)var2).$$access$$runAsync((FlywayConfigurationProperties)var3[0], (Flyway)var3[1]);
               return null;
            }
