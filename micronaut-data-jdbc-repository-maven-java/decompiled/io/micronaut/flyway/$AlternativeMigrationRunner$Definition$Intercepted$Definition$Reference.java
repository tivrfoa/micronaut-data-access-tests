...
public final class $AlternativeMigrationRunner$Definition$Intercepted$Definition$Reference
   ...
   public $AlternativeMigrationRunner$Definition$Intercepted$Definition$Reference() {
      super(
         "io.micronaut.flyway.$AlternativeMigrationRunner$Definition$Intercepted",
         "io.micronaut.flyway.$AlternativeMigrationRunner$Definition$Intercepted$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $AlternativeMigrationRunner$Definition$Intercepted$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $AlternativeMigrationRunner$Definition$Intercepted$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return $AlternativeMigrationRunner$Definition$Intercepted.class;
   }
