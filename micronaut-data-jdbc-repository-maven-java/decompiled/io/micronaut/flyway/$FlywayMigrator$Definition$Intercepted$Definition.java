...
// $FF: synthetic class
@Generated
class $FlywayMigrator$Definition$Intercepted$Definition
   extends $FlywayMigrator$Definition
   implements AdvisedBeanType<FlywayMigrator>,
   BeanFactory<$FlywayMigrator$Definition$Intercepted>,
   ProxyBeanDefinition<FlywayMigrator> {
   private static final AbstractInitializableBeanDefinition.MethodOrFieldReference $CONSTRUCTOR;

   @Override
   public $FlywayMigrator$Definition$Intercepted build(BeanResolutionContext var1, BeanContext var2, BeanDefinition var3) {
      $FlywayMigrator$Definition$Intercepted var4 = new $FlywayMigrator$Definition$Intercepted(
         var2,
      ...
      return ($FlywayMigrator$Definition$Intercepted)this.injectBean(var1, var2, var4);
   }
   ...
   static {
      ...
      $CONSTRUCTOR = new AbstractInitializableBeanDefinition.MethodReference(
         $FlywayMigrator$Definition$Intercepted.class,
         "<init>",
         new Argument[]{
   ...
   public $FlywayMigrator$Definition$Intercepted$Definition() {
      super($FlywayMigrator$Definition$Intercepted.class, $CONSTRUCTOR);
   }
