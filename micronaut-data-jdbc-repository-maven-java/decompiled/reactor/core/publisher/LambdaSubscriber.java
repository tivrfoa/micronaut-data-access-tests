...
final class LambdaSubscriber<T> implements InnerConsumer<T>, Disposable {
   ...
   static final AtomicReferenceFieldUpdater<LambdaSubscriber, Subscription> S = AtomicReferenceFieldUpdater.newUpdater(
      LambdaSubscriber.class, Subscription.class, "subscription"
   );
