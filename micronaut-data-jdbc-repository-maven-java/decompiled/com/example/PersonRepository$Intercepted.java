...
// $FF: synthetic class
@Generated
class PersonRepository$Intercepted implements PersonRepository, Introduced {
   private final Interceptor[][] $interceptors;
   private final ExecutableMethod[] $proxyMethods = new ExecutableMethod[16];

   @Override
   public Person save(String var1, Timestamp var2) {
      ...
      return (Person)var5.proceed();
   }

   @Override
   public Person update(Person var1) {
      ...
      return (Person)var4.proceed();
   }

   @Override
   public List list() {
      ExecutableMethod var1 = this.$proxyMethods[2];
      Interceptor[] var2 = this.$interceptors[2];
   ...
   public Object update(Object var1) {
      return this.update((Person)var1);
   }
   ...
   public void deleteAll() {
      ExecutableMethod var1 = this.$proxyMethods[15];
      Interceptor[] var2 = this.$interceptors[15];
      MethodInterceptorChain var3 = new MethodInterceptorChain<>(var2, this, var1);
      var3.proceed();
   }

   public PersonRepository$Intercepted(BeanResolutionContext var1, BeanContext var2, Qualifier var3, List var4) {
      this.$interceptors = new Interceptor[16][];
      $PersonRepository$Intercepted$Definition$Exec var5 = new $PersonRepository$Intercepted$Definition$Exec();
