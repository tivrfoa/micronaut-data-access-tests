...
public final class $Phone$IntrospectionRef extends AbstractBeanIntrospectionReference {
   ...
   static {
      ...
      DefaultAnnotationMetadata.registerAnnotationDefaults($micronaut_load_class_value_6(), AnnotationUtil.mapOf("value", true));
   ...
   public BeanIntrospection load() {
      return new $Phone$Introspection();
   }

   @Override
   public String getName() {
      return "com.example.Phone";
   }
