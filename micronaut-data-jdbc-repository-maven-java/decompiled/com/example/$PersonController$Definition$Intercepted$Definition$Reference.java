...
public final class $PersonController$Definition$Intercepted$Definition$Reference
   ...
   public static final AnnotationMetadata $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
      ...
      AnnotationUtil.mapOf(
         ...
         AnnotationUtil.mapOf("value", $micronaut_load_class_value_18()),
   ...
   static {
      ...
      DefaultAnnotationMetadata.registerAnnotationDefaults($micronaut_load_class_value_9(), AnnotationUtil.mapOf("groups", ArrayUtils.EMPTY_OBJECT_ARRAY));
      DefaultAnnotationMetadata.registerAnnotationDefaults(
   ...
   public $PersonController$Definition$Intercepted$Definition$Reference() {
      super(
         "com.example.$PersonController$Definition$Intercepted",
         "com.example.$PersonController$Definition$Intercepted$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $PersonController$Definition$Intercepted$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $PersonController$Definition$Intercepted$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return $PersonController$Definition$Intercepted.class;
   }
