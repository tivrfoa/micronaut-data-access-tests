...
public final class $PersonRepository$Intercepted$Definition$Reference extends AbstractInitializableBeanDefinitionReference implements AdvisedBeanType {
   ...
   static {
      ...
      DefaultAnnotationMetadata.registerAnnotationDefaults($micronaut_load_class_value_14(), AnnotationUtil.mapOf("nativeQuery", false, "readOnly", true));
      DefaultAnnotationMetadata.registerAnnotationDefaults(
      ...
      DefaultAnnotationMetadata.registerAnnotationDefaults($micronaut_load_class_value_20(), AnnotationUtil.mapOf("type", "FETCH"));
      ...
      $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  new AnnotationValue(
                     ...
                     AnnotationUtil.mapOf(
                        "interceptorType",
                        new AnnotationClassValue[]{$micronaut_load_class_value_21()},
                        "kind",
                        "INTRODUCTION",
                        "value",
         ...
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf("value", new AnnotationClassValue[]{$micronaut_load_class_value_21()}),
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  new AnnotationValue(
                     "io.micronaut.data.annotation.TypeRole",
                     AnnotationUtil.mapOf("role", "sqlMappingFunction", "type", $micronaut_load_class_value_24()),
                     var0
                  )
               }
            ),
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  ...
                  new AnnotationValue(
                     ...
                     AnnotationUtil.mapOf(
                        "interceptorType",
                        new AnnotationClassValue[]{$micronaut_load_class_value_25()},
                        "kind",
                        "AROUND",
                        "value",
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  new AnnotationValue(
                     ...
                     AnnotationUtil.mapOf("value", $micronaut_load_class_value_26()),
   ...
   public $PersonRepository$Intercepted$Definition$Reference() {
      super(
         "com.example.PersonRepository$Intercepted",
         "com.example.$PersonRepository$Intercepted$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $PersonRepository$Intercepted$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $PersonRepository$Intercepted$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return PersonRepository$Intercepted.class;
   }
