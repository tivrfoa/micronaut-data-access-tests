...
public final class $Genre$IntrospectionRef extends AbstractBeanIntrospectionReference {
   ...
   static {
      ...
      DefaultAnnotationMetadata.registerRepeatableAnnotations(
         AnnotationUtil.mapOf("javax.validation.constraints.NotNull", "javax.validation.constraints.NotNull$List")
      );
      Map var0;
      $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf("value", "genre")
         ),
         AnnotationUtil.mapOf(
            "io.micronaut.core.annotation.Introspected",
            AnnotationUtil.mapOf(
   ...
   public BeanIntrospection load() {
      return new $Genre$Introspection();
   }

   @Override
   public String getName() {
      return "com.example.Genre";
   }
