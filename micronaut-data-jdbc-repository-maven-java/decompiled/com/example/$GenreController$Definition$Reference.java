...
public final class $GenreController$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $GenreController$Definition$Reference() {
      super(
         "com.example.GenreController", "com.example.$GenreController$Definition", $ANNOTATION_METADATA, false, false, false, false, true, false, false, false
      );
   }

   @Override
   public BeanDefinition load() {
      return new $GenreController$Definition();
   }
