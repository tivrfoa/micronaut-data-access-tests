...
// $FF: synthetic class
@Generated
class $GenreRepository$Intercepted$Definition
   extends AbstractInitializableBeanDefinition<GenreRepository$Intercepted>
   implements AdvisedBeanType<GenreRepository>,
   BeanFactory<GenreRepository$Intercepted> {
   ...
   @Override
   public GenreRepository$Intercepted build(BeanResolutionContext var1, BeanContext var2, BeanDefinition var3) {
      GenreRepository$Intercepted var4 = new GenreRepository$Intercepted(
         var1,
         var2,
      ...
      return (GenreRepository$Intercepted)this.injectBean(var1, var2, var4);
   }

   @Override
   protected Object injectBean(BeanResolutionContext var1, BeanContext var2, Object var3) {
      GenreRepository$Intercepted var4 = (GenreRepository$Intercepted)var3;
   ...
   static {
      ...
      $CONSTRUCTOR = new AbstractInitializableBeanDefinition.MethodReference(
         GenreRepository$Intercepted.class,
         "<init>",
         new Argument[]{
               ...
               AnnotationUtil.mapOf(
                  ...
                  new AnnotationValue[]{
                     new AnnotationValue(
                        ...
                        AnnotationUtil.mapOf("role", "sqlMappingFunction", "type", $micronaut_load_class_value_8()),
   ...
   public $GenreRepository$Intercepted$Definition() {
      this(GenreRepository$Intercepted.class, $CONSTRUCTOR);
   }

   protected $GenreRepository$Intercepted$Definition(Class var1, AbstractInitializableBeanDefinition.MethodOrFieldReference var2) {
      super(
         var1,
         var2,
         ...
         null,
         null,
         new $GenreRepository$Intercepted$Definition$Exec(),
         $TYPE_ARGUMENTS,
