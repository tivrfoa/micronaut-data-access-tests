...
public final class $PersonController$Definition$Reference extends AbstractInitializableBeanDefinitionReference {
   ...
   public $PersonController$Definition$Reference() {
      super(
         "com.example.PersonController",
         "com.example.$PersonController$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $PersonController$Definition();
   }
