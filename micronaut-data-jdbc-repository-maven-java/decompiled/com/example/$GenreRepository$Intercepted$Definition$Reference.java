...
public final class $GenreRepository$Intercepted$Definition$Reference extends AbstractInitializableBeanDefinitionReference implements AdvisedBeanType {
   ...
   static {
      ...
      DefaultAnnotationMetadata.registerAnnotationType($micronaut_load_class_value_22());
      ...
      $ANNOTATION_METADATA = new DefaultAnnotationMetadata(
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  new AnnotationValue(
                     ...
                     AnnotationUtil.mapOf(
                        "interceptorType",
                        new AnnotationClassValue[]{$micronaut_load_class_value_24()},
                        "kind",
                        "INTRODUCTION",
                        "value",
         ...
         AnnotationUtil.mapOf(
            ...
            AnnotationUtil.mapOf("value", new AnnotationClassValue[]{$micronaut_load_class_value_24()}),
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  new AnnotationValue(
                     "io.micronaut.data.annotation.TypeRole",
                     AnnotationUtil.mapOf("role", "sqlMappingFunction", "type", $micronaut_load_class_value_27()),
                     var0
                  )
               }
            ),
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  ...
                  new AnnotationValue(
                     ...
                     AnnotationUtil.mapOf(
                        "interceptorType",
                        new AnnotationClassValue[]{$micronaut_load_class_value_28()},
                        "kind",
                        "AROUND",
                        "value",
            ...
            AnnotationUtil.mapOf(
               ...
               new AnnotationValue[]{
                  new AnnotationValue(
                     ...
                     AnnotationUtil.mapOf("value", $micronaut_load_class_value_29()),
   ...
   public $GenreRepository$Intercepted$Definition$Reference() {
      super(
         "com.example.GenreRepository$Intercepted",
         "com.example.$GenreRepository$Intercepted$Definition",
         $ANNOTATION_METADATA,
         false,
         false,
         false,
   ...
   public BeanDefinition load() {
      return new $GenreRepository$Intercepted$Definition();
   }

   @Override
   public Class getBeanDefinitionType() {
      return $GenreRepository$Intercepted$Definition.class;
   }

   @Override
   public Class getBeanType() {
      return GenreRepository$Intercepted.class;
   }
