...
public final class AnnotatedClass extends Annotated implements TypeResolutionContext {
   ...
   public Iterable<Annotation> annotations() {
      ...
      } else if (!(this._classAnnotations instanceof AnnotationCollector.OneAnnotation)
         && !(this._classAnnotations instanceof AnnotationCollector.TwoAnnotations)) {
   ...
   private final List<AnnotatedField> _fields() {
      ...
      if (f == null) {
         if (this._type == null) {
            ...
            f = AnnotatedFieldCollector.collectFields(
               this._annotationIntrospector, this, this._mixInResolver, this._typeFactory, this._type, this._collectAnnotations
            );
         }
   ...
   private final AnnotatedClass.Creators _creators() {
      ...
      if (c == null) {
         if (this._type == null) {
            ...
            c = AnnotatedCreatorCollector.collectCreators(
               this._annotationIntrospector, this._typeFactory, this, this._type, this._primaryMixIn, this._collectAnnotations
            );
         }
