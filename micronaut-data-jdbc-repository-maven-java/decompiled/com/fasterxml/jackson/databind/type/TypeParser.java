...
public class TypeParser implements Serializable {
   ...
   public JavaType parse(String canonical) throws IllegalArgumentException {
      TypeParser.MyTokenizer tokens = new TypeParser.MyTokenizer(canonical.trim());
   ...
   protected IllegalArgumentException _problem(TypeParser.MyTokenizer tokens, String msg) {
      return new IllegalArgumentException(
         String.format("Failed to parse type '%s' (remaining: '%s'): %s", tokens.getAllInput(), tokens.getRemainingInput(), msg)
      );
   }
