...
public abstract class DeserializationContext extends DatabindContext implements Serializable {
   ...
   public final Object findInjectableValue(Object valueId, BeanProperty forProperty, Object beanInstance) throws JsonMappingException {
      return this._injectableValues == null
         ...
         : this._injectableValues.findInjectableValue(valueId, this, forProperty, beanInstance);
   }
   ...
   public final KeyDeserializer findKeyDeserializer(JavaType keyType, BeanProperty prop) throws JsonMappingException {
      ...
      try {
         ...
         this.reportBadDefinition(keyType, ClassUtil.exceptionMessage(var5));
         kd = null;
      }
   ...
   public <T> T readPropertyValue(JsonParser p, BeanProperty prop, JavaType type) throws IOException {
      ...
      return (T)(deser == null
         ? this.reportBadDefinition(
            type, String.format("Could not find JsonDeserializer for type %s (via property %s)", ClassUtil.getTypeDescription(type), ClassUtil.nameOf(prop))
         )
         : deser.deserialize(p, this));
   }
   ...
   public JsonNode readTree(JsonParser p) throws IOException {
      ...
      return (JsonNode)(t == JsonToken.VALUE_NULL
         ? this.getNodeFactory().nullNode()
         : (JsonNode)this.findRootValueDeserializer(this._config.constructType(JsonNode.class)).deserialize(p, this));
   }
   ...
   public <T> T readTreeAsValue(JsonNode n, Class<T> targetType) throws IOException {
      if (n == null) {
         ...
         Object var5;
         try {
            var5 = this.readValue(p, targetType);
         ...
         if (key != DeserializationProblemHandler.NOT_HANDLED) {
            ...
            throw this.weirdNumberException(
               ...
               this._format(
                  ...
                  new Object[]{ClassUtil.getClassDescription(targetClass), ClassUtil.getClassDescription(key)}
               )
            );
         }
      }
            ...
            if (goodValue != null && !raw.isInstance(goodValue)) {
               throw JsonMappingException.from(
                  ...
                  this._format(
                     ...
                     new Object[]{ClassUtil.getClassDescription(targetType), ClassUtil.getClassDescription(goodValue)}
                  )
               );
            }
   ...
   public Object handleUnexpectedToken(Class<?> instClass, JsonParser p) throws IOException {
      return this.handleUnexpectedToken(this.constructType(instClass), p.currentToken(), p, null);
   }
   ...
   public Object handleUnexpectedToken(JavaType targetType, JsonParser p) throws IOException {
      return this.handleUnexpectedToken(targetType, p.currentToken(), p, null);
   }
   ...
   public JsonMappingException instantiationException(Class<?> instClass, String msg0) {
      return ValueInstantiationException.from(
         this._parser, String.format("Cannot construct instance of %s: %s", ClassUtil.nameOf(instClass), msg0), this.constructType(instClass)
      );
   }
