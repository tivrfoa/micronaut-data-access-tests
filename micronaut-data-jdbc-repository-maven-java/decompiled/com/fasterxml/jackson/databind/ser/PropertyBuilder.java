...
public class PropertyBuilder {
   ...
   protected BeanPropertyWriter buildWriter(
      ...
      try {
         ...
         if (propDef == null) {
            return prov.reportBadDefinition(declaredType, ClassUtil.exceptionMessage(var22));
         }

         return prov.reportBadPropertyDefinition(this._beanDesc, propDef, ClassUtil.exceptionMessage(var22));
      }
      ...
      if (accessor == null) {
         ...
         BeanPropertyWriter bpw = this._constructPropertyWriter(
