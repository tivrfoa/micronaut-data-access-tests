...
public final class StringArrayDeserializer extends StdDeserializer<String[]> implements ContextualDeserializer {
   ...
   public JsonDeserializer<?> createContextual(DeserializationContext ctxt, BeanProperty property) throws JsonMappingException {
      ...
      return this._elementDeserializer == deser && Objects.equals(this._unwrapSingle, unwrapSingle) && this._nullProvider == nuller
         ? this
   ...
   private final String[] handleNonArray(JsonParser p, DeserializationContext ctxt) throws IOException {
      ...
      if (canWrap) {
         ...
         return p.hasToken(JsonToken.VALUE_STRING) ? this._deserializeFromString(p, ctxt) : (String[])ctxt.handleUnexpectedToken(this._valueClass, p);
      }
   }
}
