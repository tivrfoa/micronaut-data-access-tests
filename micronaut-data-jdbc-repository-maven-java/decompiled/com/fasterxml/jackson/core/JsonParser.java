...
public abstract class JsonParser implements Closeable, Versioned {
   ...
   public byte getByteValue() throws IOException {
      ...
      if (value >= -128 && value <= 255) {
         ...
         throw new InputCoercionException(
            this, String.format("Numeric value (%s) out of range of Java byte", this.getText()), JsonToken.VALUE_NUMBER_INT, Byte.TYPE
         );
      }
   }
   ...
   public short getShortValue() throws IOException {
      ...
      if (value >= -32768 && value <= 32767) {
         ...
         throw new InputCoercionException(
            this, String.format("Numeric value (%s) out of range of Java short", this.getText()), JsonToken.VALUE_NUMBER_INT, Short.TYPE
         );
      }
   }
