...
public final class NumberOutput {
   ...
   public static int outputInt(int v, char[] b, int off) {
      ...
      if (v < MILLION) {
         ...
         int var13 = newValue / 1000;
         int thousands = newValue - var13 * 1000;
         off = _leading3(var13, b, off);
   ...
   public static int outputInt(int v, byte[] b, int off) {
      ...
      if (v < MILLION) {
         ...
         int newValue = v / 1000;
         int ones = v - newValue * 1000;
         int var14 = newValue / 1000;
         int thousands = newValue - var14 * 1000;
         off = _leading3(var14, b, off);
         off = _full3(thousands, b, off);
         return _full3(ones, b, off);
      }
   }
