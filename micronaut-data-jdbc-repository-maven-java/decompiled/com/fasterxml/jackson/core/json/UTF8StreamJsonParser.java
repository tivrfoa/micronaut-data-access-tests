...
public class UTF8StreamJsonParser extends ParserBase {
   ...
   protected final JsonToken _parseFloatThatStartsWithPeriod() throws IOException {
      return !this.isEnabled(JsonReadFeature.ALLOW_LEADING_DECIMAL_POINT_FOR_NUMBERS.mappedFeature())
         ? this._handleUnexpectedValue(46)
         : this._parseFloat(this._textBuffer.emptyAndGetCurrentSegment(), 0, 46, false, 0);
   }
   ...
   protected final byte[] _decodeBase64(Base64Variant b64variant) throws IOException {
      ...
      while(true) {
         ...
         int var13 = bits << 6 | bits;
         if (this._inputPtr >= this._inputEnd) {
            this._loadMoreGuaranteed();
         }

         var6 = this._inputBuffer[this._inputPtr++] & 255;
         bits = b64variant.decodeBase64Char(var6);
         if (bits < 0) {
            if (bits != -2) {
               if (var6 == 34) {
            ...
            if (bits == -2) {
               ...
               var6 = this._inputBuffer[this._inputPtr++] & 255;
               if (!b64variant.usesPaddingChar(var6) && this._decodeBase64Escape(b64variant, var6, 3) != -2) {
         ...
         var13 = var13 << 6 | bits;
         builder.appendThreeBytes(var13);
      }
   }
