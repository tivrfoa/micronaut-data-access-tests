...
public final class ByteQuadsCanonicalizer {
   ...
   public ByteQuadsCanonicalizer makeChild(int flags) {
      return new ByteQuadsCanonicalizer(
         this,
         this._seed,
         (ByteQuadsCanonicalizer.TableInfo)this._tableInfo.get(),
   ...
   public ByteQuadsCanonicalizer makeChildOrPlaceholder(int flags) {
      return JsonFactory.Feature.CANONICALIZE_FIELD_NAMES.enabledIn(flags)
         ...
         : new ByteQuadsCanonicalizer((ByteQuadsCanonicalizer.TableInfo)this._tableInfo.get());
   }
