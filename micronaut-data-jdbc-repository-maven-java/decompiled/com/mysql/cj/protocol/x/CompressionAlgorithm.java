...
public class CompressionAlgorithm {
   ...
   public static Map<String, CompressionAlgorithm> getDefaultInstances() {
      ...
      defaultInstances.put(
         "deflate_stream", new CompressionAlgorithm("deflate_stream", InflaterInputStream.class.getName(), SyncFlushDeflaterOutputStream.class.getName())
      );
   ...
   public CompressionAlgorithm(String name, String inputStreamClassFqn, String outputStreamClassFqn) {
      ...
      if (nameMode.length != 2) {
         throw (WrongArgumentException)ExceptionFactory.createException(
            WrongArgumentException.class, Messages.getString("Protocol.Compression.4", new Object[]{name})
         );
      } else {
         try {
            ...
            throw (WrongArgumentException)ExceptionFactory.createException(
               WrongArgumentException.class, Messages.getString("Protocol.Compression.5", new Object[]{nameMode[1]})
            );
         }
   ...
   public Class<?> getInputStreamClass() {
      if (this.inputStreamClass == null) {
         try {
            ...
            throw (WrongArgumentException)ExceptionFactory.createException(
               WrongArgumentException.class, Messages.getString("Protocol.Compression.3", new Object[]{this.inputStreamClassFqn}), var2
            );
         }
      }
   ...
   public Class<?> getOutputStreamClass() {
      if (this.outputStreamClass == null) {
         try {
            ...
            throw (WrongArgumentException)ExceptionFactory.createException(
               WrongArgumentException.class, Messages.getString("Protocol.Compression.3", new Object[]{this.outputStreamClassFqn}), var2
            );
         }
      }
