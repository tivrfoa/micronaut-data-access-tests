...
public class XMessageBuilder implements MessageBuilder<XMessage> {
      ...
      keyValuePair.forEach(
         (k, v) -> {
            ...
            if (!XServerCapabilities.KEY_SESSION_CONNECT_ATTRS.equals(k) && !XServerCapabilities.KEY_COMPRESSION.equals(k)) {
               ...
               ((Map)v)
                  .forEach(
                     (name, value) -> attrB.addFld(
                           MysqlxDatatypes.Object.ObjectField.newBuilder().setKey(name).setValue(ExprUtil.argObjectToScalarAny(value)).build()
                        )
                  );
   ...
   public XMessage buildPrepareDocUpdate(int preparedStatementId, FilterParams filterParams, List<UpdateSpec> updates) {
      ...
      builder.setStmt(
         MysqlxPrepare.Prepare.OneOfMessage.newBuilder().setType(MysqlxPrepare.Prepare.OneOfMessage.Type.UPDATE).setUpdate(updateBuilder.build()).build()
      );
      return new XMessage(builder.build());
   }
   ...
   public XMessage buildPrepareFind(int preparedStatementId, FilterParams filterParams) {
      ...
      MysqlxPrepare.Prepare.Builder builder = MysqlxPrepare.Prepare.newBuilder().setStmtId(preparedStatementId);
      builder.setStmt(
         MysqlxPrepare.Prepare.OneOfMessage.newBuilder().setType(MysqlxPrepare.Prepare.OneOfMessage.Type.FIND).setFind(findBuilder.build()).build()
      );
      return new XMessage(builder.build());
   }
   ...
   public XMessage buildPrepareDelete(int preparedStatementId, FilterParams filterParams) {
      ...
      MysqlxPrepare.Prepare.Builder builder = MysqlxPrepare.Prepare.newBuilder().setStmtId(preparedStatementId);
      builder.setStmt(
         MysqlxPrepare.Prepare.OneOfMessage.newBuilder().setType(MysqlxPrepare.Prepare.OneOfMessage.Type.DELETE).setDelete(deleteBuilder.build()).build()
      );
      return new XMessage(builder.build());
   }
   ...
   public XMessage buildSqlStatement(String statement, List<Object> args) {
      ...
      if (args != null) {
         builder.addAllArgs((Iterable<? extends MysqlxDatatypes.Any>)args.stream().map(ExprUtil::argObjectToScalarAny).collect(Collectors.toList()));
      }
   ...
   public XMessage buildPrepareSqlStatement(int preparedStatementId, String statement) {
      ...
      MysqlxPrepare.Prepare.Builder builder = MysqlxPrepare.Prepare.newBuilder().setStmtId(preparedStatementId);
      builder.setStmt(
         MysqlxPrepare.Prepare.OneOfMessage.newBuilder().setType(MysqlxPrepare.Prepare.OneOfMessage.Type.STMT).setStmtExecute(stmtExecBuilder.build()).build()
      );
      return new XMessage(builder.build());
   }
   ...
   private static void applyFilterParams(
      FilterParams filterParams, Consumer<List<MysqlxCrud.Order>> setOrder, Consumer<MysqlxCrud.LimitExpr> setLimit, Consumer<MysqlxExpr.Expr> setCriteria
   ) {
      if (filterParams.getOrder() != null) {
         setOrder.accept((List)filterParams.getOrder());
      }
   ...
   public XMessage buildPrepareExecute(int preparedStatementId, FilterParams filterParams) {
      ...
      if (filterParams.getArgs() != null) {
         builder.addAllArgs(
            (Iterable<? extends MysqlxDatatypes.Any>)((List)filterParams.getArgs())
               .stream()
               .map(s -> MysqlxDatatypes.Any.newBuilder().setType(MysqlxDatatypes.Any.Type.SCALAR).setScalar(s).build())
   ...
   public XMessage buildCreateCollection(String schemaName, String collectionName, Schema.CreateCollectionOptions options) {
      if (schemaName == null) {
         ...
         MysqlxDatatypes.Object.Builder argsBuilder = MysqlxDatatypes.Object.newBuilder()
         ...
         if (options.getValidation() != null) {
            ...
            if (options.getValidation().getSchema() != null) {
               validationBuilder.addFld(
                  MysqlxDatatypes.Object.ObjectField.newBuilder().setKey("schema").setValue(ExprUtil.buildAny(options.getValidation().getSchema()))
               );
            }
            ...
            if (options.getValidation().getLevel() != null) {
               validationBuilder.addFld(
                  MysqlxDatatypes.Object.ObjectField.newBuilder()
                     .setKey("level")
                     .setValue(ExprUtil.buildAny(options.getValidation().getLevel().name().toLowerCase()))
               );
            }
            ...
            optBuilder.addFld(
               MysqlxDatatypes.Object.ObjectField.newBuilder()
                  .setKey("validation")
                  .setValue(MysqlxDatatypes.Any.newBuilder().setType(MysqlxDatatypes.Any.Type.OBJECT).setObj(validationBuilder))
            );
         }
         ...
         if (hasOptions) {
            argsBuilder.addFld(
               MysqlxDatatypes.Object.ObjectField.newBuilder()
                  .setKey("options")
                  .setValue(MysqlxDatatypes.Any.newBuilder().setType(MysqlxDatatypes.Any.Type.OBJECT).setObj(optBuilder))
            );
         }
         ...
         return new XMessage(
            this.buildXpluginCommand(
               ...
               MysqlxDatatypes.Any.newBuilder().setType(MysqlxDatatypes.Any.Type.OBJECT).setObj(argsBuilder).build()
            )
         );
      }
   }
   ...
   public XMessage buildListObjects(String schemaName, String pattern) {
      if (schemaName == null) {
         ...
         return new XMessage(
            this.buildXpluginCommand(
               XpluginStatementCommand.XPLUGIN_STMT_LIST_OBJECTS, MysqlxDatatypes.Any.newBuilder().setType(MysqlxDatatypes.Any.Type.OBJECT).setObj(obj).build()
            )
         );
      }
   }
   ...
   public XMessage buildCreateCollectionIndex(String schemaName, String collectionName, CreateIndexParams params) {
      ...
      for(CreateIndexParams.IndexField indexField : params.getFields()) {
         MysqlxDatatypes.Object.Builder fBuilder = MysqlxDatatypes.Object.newBuilder()
   ...
   public XMessage buildExpectOpen() {
      return new XMessage(
         MysqlxExpect.Open.newBuilder()
            .addCond(MysqlxExpect.Open.Condition.newBuilder().setConditionKey(2).setConditionValue(ByteString.copyFromUtf8("6.1")))
            .build()
      );
   }
