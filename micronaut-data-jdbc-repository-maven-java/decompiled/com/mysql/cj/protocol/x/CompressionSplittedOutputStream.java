   ...
   private void finalizeWrite() throws IOException {
      if (this.isWriteComplete()) {
         if (this.compressionEnabled) {
            ...
            MysqlxConnection.Compression compressedMessage = MysqlxConnection.Compression.newBuilder()
               .setUncompressedSize((long)(5 + this.framePayloadLength))
               .setClientMessages(Mysqlx.ClientMessages.Type.forNumber(this.xMessageHeader.getMessageType()))
