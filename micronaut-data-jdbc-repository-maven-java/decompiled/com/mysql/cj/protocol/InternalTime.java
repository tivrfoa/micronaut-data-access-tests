...
public class InternalTime {
   ...
   public String toString() {
      return this.nanos > 0
         ? String.format("%02d:%02d:%02d.%s", this.hours, this.minutes, this.seconds, TimeUtil.formatNanos(this.nanos, this.scale, false))
         : String.format("%02d:%02d:%02d", this.hours, this.minutes, this.seconds);
   }
}
