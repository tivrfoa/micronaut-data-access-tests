...
public class NativeProtocol extends AbstractProtocol<NativePacketPayload> implements Protocol<NativePacketPayload>, RuntimeProperty.RuntimePropertyListener {
   ...
   public Supplier<ValueEncoder> getValueEncoderSupplier(Object obj) {
      if (obj == null) {
         ...
         if (res == null) {
            Optional<Supplier<ValueEncoder>> mysqlType = DEFAULT_ENCODERS.entrySet()
               .stream()
               .filter(m -> ((Class)m.getKey()).isAssignableFrom(obj.getClass()))
               .map(m -> (Supplier)m.getValue())
               .findFirst();
   ...
   public void negotiateSSLConnection() {
      if (!ExportControlled.enabled()) {
         ...
         try {
            ...
            throw ExceptionFactory.createCommunicationsException(
               this.propertySet, this.serverSession, this.getPacketSentTimeHolder(), this.getPacketReceivedTimeHolder(), var6, this.getExceptionInterceptor()
            );
         }
      }
   }
            ...
            this.socketConnection
               .setMysqlInput(
                  new FullReadInputStream(
                     new CompressedInputStream(this.socketConnection.getMysqlInput(), this.propertySet.getBooleanProperty(PropertyKey.traceProtocol), this.log)
                  )
               );
         ...
         try {
            ...
            this.sendCommand(
               this.getCommandBuilder()
                  .buildComQuery(this.getSharedSendPacket(), "CREATE DATABASE IF NOT EXISTS " + StringUtils.quoteIdentifier(database, true)),
               false,
               0
            );
            this.sendCommand(this.getCommandBuilder().buildComInitDb(this.getSharedSendPacket(), database), false, 0);
   ...
   public final void send(Message packet, int packetLen) {
      try {
         if (this.maxAllowedPacket.getValue() > 0 && packetLen > this.maxAllowedPacket.getValue()) {
            throw new CJPacketTooBigException((long)packetLen, (long)((Integer)this.maxAllowedPacket.getValue()).intValue());
         } else {
            ++this.packetSequence;
         ...
         throw ExceptionFactory.createCommunicationsException(
            this.getPropertySet(), this.serverSession, this.getPacketSentTimeHolder(), this.getPacketReceivedTimeHolder(), var4, this.getExceptionInterceptor()
         );
      }
   }
   ...
   public void checkErrorMessage(NativePacketPayload resultPacket) {
      ...
      if (statusCode == -1) {
         ...
         String serverErrorMessage = resultPacket.readString(
            NativeConstants.StringSelfDataType.STRING_TERM, this.serverSession.getCharsetSettings().getErrorMessageEncoding()
         );
         ...
         if (xOpen != null) {
            ...
            if (errno == 4031) {
               throw (CJCommunicationsException)ExceptionFactory.createException(
                  CJCommunicationsException.class, errorBuf.toString(), null, this.getExceptionInterceptor()
               );
            }
         }
         ...
         label264: {
            label263: {
               if (this.logSlowQueries) {
                  ...
                  } else if (queryDuration > (long)((Integer)this.propertySet.getIntegerProperty(PropertyKey.slowQueryThresholdMillis).getValue()).intValue()) {
                     break label263;
                  }
               }
         ...
         if (this.profileSQL || queryWasSlow) {
            ...
            if (this.logSlowQueries) {
               ...
               if (this.serverSession.noGoodIndexUsed()) {
                  eventSink.processEvent(
                     (byte)6, this.session, callingQuery, rs, queryDuration, new Throwable(), Messages.getString("Protocol.4") + extractedQuery
                  );
               }

               if (this.serverSession.noIndexUsed()) {
                  eventSink.processEvent(
                     (byte)6, this.session, callingQuery, rs, queryDuration, new Throwable(), Messages.getString("Protocol.5") + extractedQuery
                  );
               }

               if (this.serverSession.queryWasSlow()) {
                  eventSink.processEvent(
                     (byte)6, this.session, callingQuery, rs, queryDuration, new Throwable(), Messages.getString("Protocol.ServerSlowQuery") + extractedQuery
                  );
               }
            }
      ...
      if (StringUtils.startsWithIgnoreCaseAndWs(truncatedQuery, "SELECT")
         ...
         try {
            NativePacketPayload resultPacket = this.sendCommand(
               this.getCommandBuilder().buildComQuery(this.getSharedSendPacket(), "EXPLAIN " + query), false, 0
            );
   ...
   private void calculateSlowQueryThreshold() {
      this.slowQueryThreshold = (long)((Integer)this.propertySet.getIntegerProperty(PropertyKey.slowQueryThresholdMillis).getValue()).intValue();
   ...
   public static MysqlType findMysqlType(
      ...
      switch(mysqlTypeId) {
         ...
         case 15:
         case 253:
            return !isOpaqueBinary || isFromFunction && propertySet.getBooleanProperty(PropertyKey.functionsNeverReturnBlobs).getValue()
               ? MysqlType.VARCHAR
               : MysqlType.VARBINARY;
         case 16:
            return MysqlType.BIT;
   ...
   public final NativePacketPayload sendFileToServer(String fileName) {
      ...
      if (filePacket == null) {
         try {
            ...
            throw ExceptionFactory.createException(
               Messages.getString("MysqlIO.111", new Object[]{packetLength}), "HY001", 0, false, var20, this.exceptionInterceptor
            );
         }
      }
      ...
      try {
         ...
         throw ExceptionFactory.createException(messageBuf.toString(), var21, this.exceptionInterceptor);
      } finally {
         if (fileIn != null) {
            try {
               fileIn.close();
            } catch (Exception var19) {
               throw ExceptionFactory.createException(Messages.getString("MysqlIO.65"), var19, this.exceptionInterceptor);
            }

            BufferedInputStream var23 = null;
         } else {
            filePacket.setPosition(0);
            this.send(filePacket, filePacket.getPosition());
   ...
   private BufferedInputStream getFileStream(String fileName) throws IOException {
      ...
      } else if (allowLoadLocalInfile.getValue()) {
            ...
            if (allowUrlInLocalInfile.getValue()) {
               try {
                  ...
                  if (!urlFromFileName.getProtocol().equalsIgnoreCase("file")) {
                     throw ExceptionFactory.createException(
                        Messages.getString("MysqlIO.66", new Object[]{urlFromFileName.getProtocol()}), this.exceptionInterceptor
                     );
                  }
                  ...
                  try {
                     ...
                     if (!addr.isLoopbackAddress()) {
                        throw ExceptionFactory.createException(
                           Messages.getString("MysqlIO.67", new Object[]{urlFromFileName.getHost()}), this.exceptionInterceptor
                        );
                     }
                  } catch (UnknownHostException var15) {
                     throw ExceptionFactory.createException(Messages.getString("MysqlIO.68", new Object[]{fileName}), var15, this.exceptionInterceptor);
                  }
   ...
   private void appendDeadlockStatusInformation(Session sess, String xOpen, StringBuilder errorBuf) {
      if (sess.getPropertySet().getBooleanProperty(PropertyKey.includeInnodbStatusInDeadlockExceptions).getValue()
         ...
         try {
            NativePacketPayload resultPacket = this.sendCommand(
               this.getCommandBuilder().buildComQuery(this.getSharedSendPacket(), "SHOW ENGINE INNODB STATUS"), false, 0
            );
            Resultset rs = this.readAllResults(-1, false, resultPacket, false, null, new ResultsetFactory(Resultset.Type.FORWARD_ONLY, null));
            int colIndex = 0;
            Field f = null;
      ...
      if (this.warningCount == 0) {
         ...
         try {
            ...
            Resultset warnRs = this.readAllResults(
               -1, this.warningCount > 99, resultPacket, false, null, new ResultsetFactory(Resultset.Type.FORWARD_ONLY, Resultset.Concurrency.READ_ONLY)
            );
            ...
            var19 = currentWarning;
         } catch (IOException var17) {
            throw ExceptionFactory.createException(var17.getMessage(), var17);
         } finally {
            if (rows != null) {
               rows.close();
            }
