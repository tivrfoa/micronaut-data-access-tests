                  ...
                  .sendCommand(
                     this.commandBuilder
                        .buildComQuery(
                           ...
                           (String)this.protocol.getPropertySet().getStringProperty(PropertyKey.characterEncoding).getValue()
                        ),
                     false,
                     0
                  );
   ...
   public Row next() {
      try {
         ...
         CJException cjEx = ExceptionFactory.createException(
            Messages.getString("RowDataDynamic.2", new String[]{var4.getClass().getName(), var4.getMessage(), Util.stackTraceToString(var4)}),
            var4,
