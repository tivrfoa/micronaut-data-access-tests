...
public class ExceptionFactory {
   ...
   public static <T extends CJException> T createException(Class<T> clazz, String message) {
      T sqlEx;
      try {
         sqlEx = (T)clazz.getConstructor(String.class).newInstance(message);
   ...
   public static <T extends CJException> T createException(Class<T> clazz, String message, ExceptionInterceptor interceptor) {
      return createException(clazz, message);
   }
   ...
   public static CJException createException(
      String message, String sqlState, int vendorErrorCode, boolean isTransient, Throwable cause, ExceptionInterceptor interceptor
   ) {
   ...
   public static <T extends CJException> T createException(Class<T> clazz, String message, Throwable cause, ExceptionInterceptor interceptor) {
      return createException(clazz, message, cause);
   }
   ...
   public static String createLinkFailureMessageBasedOnHeuristics(
      ...
      if (propertySet != null) {
         ...
         if (serverSession != null) {
            serverTimeoutSecondsStr = isInteractiveClient
      ...
      if (dueToTimeout != 1 && dueToTimeout != 2) {
         ...
         exceptionMessageBuf.append(
            lastPacketReceivedTimeMs != 0L
               ? Messages.getString("CommunicationsException.ServerPacketTimingInfo", new Object[]{timeSinceLastPacketReceivedMs, timeSinceLastPacketSentMs})
