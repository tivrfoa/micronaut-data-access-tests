...
public class CharsetMapping {
   ...
   static {
      MysqlCharset[] charset = new MysqlCharset[]{
         new MysqlCharset("ascii", 1, 0, new String[]{"US-ASCII", "ASCII"}),
         new MysqlCharset("big5", 2, 0, new String[]{"Big5"}),
         new MysqlCharset("gbk", 2, 0, new String[]{"GBK"}),
         new MysqlCharset("sjis", 2, 0, new String[]{"SHIFT_JIS", "Cp943", "WINDOWS-31J"}),
         new MysqlCharset("cp932", 2, 1, new String[]{"WINDOWS-31J"}),
         new MysqlCharset("gb2312", 2, 0, new String[]{"GB2312"}),
         new MysqlCharset("ujis", 3, 0, new String[]{"EUC_JP"}),
         new MysqlCharset("eucjpms", 3, 0, new String[]{"EUC_JP_Solaris"}, new ServerVersion(5, 0, 3)),
         new MysqlCharset("gb18030", 4, 0, new String[]{"GB18030"}, new ServerVersion(5, 7, 4)),
         new MysqlCharset("euckr", 2, 0, new String[]{"EUC-KR"}),
         new MysqlCharset("latin1", 1, 1, new String[]{"Cp1252", "ISO8859_1"}),
         new MysqlCharset("swe7", 1, 0, new String[]{"Cp1252"}),
         new MysqlCharset("hp8", 1, 0, new String[]{"Cp1252"}),
         new MysqlCharset("dec8", 1, 0, new String[]{"Cp1252"}),
         new MysqlCharset("armscii8", 1, 0, new String[]{"Cp1252"}),
         new MysqlCharset("geostd8", 1, 0, new String[]{"Cp1252"}),
         new MysqlCharset("latin2", 1, 0, new String[]{"ISO8859_2"}),
         new MysqlCharset("greek", 1, 0, new String[]{"ISO8859_7", "greek"}),
         new MysqlCharset("latin7", 1, 0, new String[]{"ISO-8859-13"}),
         new MysqlCharset("hebrew", 1, 0, new String[]{"ISO8859_8"}),
         new MysqlCharset("latin5", 1, 0, new String[]{"ISO8859_9"}),
         new MysqlCharset("cp850", 1, 0, new String[]{"Cp850", "Cp437"}),
         new MysqlCharset("cp852", 1, 0, new String[]{"Cp852"}),
         new MysqlCharset("keybcs2", 1, 0, new String[]{"Cp852"}),
         new MysqlCharset("cp866", 1, 0, new String[]{"Cp866"}),
         new MysqlCharset("koi8r", 1, 1, new String[]{"KOI8_R"}),
         new MysqlCharset("koi8u", 1, 0, new String[]{"KOI8_R"}),
         new MysqlCharset("tis620", 1, 0, new String[]{"TIS620"}),
         new MysqlCharset("cp1250", 1, 0, new String[]{"Cp1250"}),
         new MysqlCharset("cp1251", 1, 1, new String[]{"Cp1251"}),
         new MysqlCharset("cp1256", 1, 0, new String[]{"Cp1256"}),
         new MysqlCharset("cp1257", 1, 0, new String[]{"Cp1257"}),
         new MysqlCharset("macroman", 1, 0, new String[]{"MacRoman"}),
         new MysqlCharset("macce", 1, 0, new String[]{"MacCentralEurope"}),
         new MysqlCharset("utf8mb3", 3, 0, new String[]{"UTF-8"}, new String[]{"utf8"}),
         new MysqlCharset("utf8mb4", 4, 1, new String[]{"UTF-8"}),
         new MysqlCharset("binary", 1, 1, new String[]{"ISO8859_1"}),
         new MysqlCharset("ucs2", 2, 0, new String[]{"UnicodeBig"}),
         new MysqlCharset("utf16", 4, 0, new String[]{"UTF-16"}),
         new MysqlCharset("utf16le", 4, 0, new String[]{"UTF-16LE"}),
      ...
      collation[33] = new Collation(33, "utf8_general_ci", 1, "utf8mb3");
      ...
      collation[76] = new Collation(76, "utf8_tolower_ci", 0, "utf8mb3");
      ...
      collation[83] = new Collation(83, "utf8_bin", 0, "utf8mb3");
      ...
      collation[192] = new Collation(192, "utf8_unicode_ci", 0, "utf8mb3");
      collation[193] = new Collation(193, "utf8_icelandic_ci", 0, "utf8mb3");
      collation[194] = new Collation(194, "utf8_latvian_ci", 0, "utf8mb3");
      collation[195] = new Collation(195, "utf8_romanian_ci", 0, "utf8mb3");
      collation[196] = new Collation(196, "utf8_slovenian_ci", 0, "utf8mb3");
      collation[197] = new Collation(197, "utf8_polish_ci", 0, "utf8mb3");
      collation[198] = new Collation(198, "utf8_estonian_ci", 0, "utf8mb3");
      collation[199] = new Collation(199, "utf8_spanish_ci", 0, "utf8mb3");
      collation[200] = new Collation(200, "utf8_swedish_ci", 0, "utf8mb3");
      collation[201] = new Collation(201, "utf8_turkish_ci", 0, "utf8mb3");
      collation[202] = new Collation(202, "utf8_czech_ci", 0, "utf8mb3");
      collation[203] = new Collation(203, "utf8_danish_ci", 0, "utf8mb3");
      collation[204] = new Collation(204, "utf8_lithuanian_ci", 0, "utf8mb3");
      collation[205] = new Collation(205, "utf8_slovak_ci", 0, "utf8mb3");
      collation[206] = new Collation(206, "utf8_spanish2_ci", 0, "utf8mb3");
      collation[207] = new Collation(207, "utf8_roman_ci", 0, "utf8mb3");
      collation[208] = new Collation(208, "utf8_persian_ci", 0, "utf8mb3");
      collation[209] = new Collation(209, "utf8_esperanto_ci", 0, "utf8mb3");
      collation[210] = new Collation(210, "utf8_hungarian_ci", 0, "utf8mb3");
      collation[211] = new Collation(211, "utf8_sinhala_ci", 0, "utf8mb3");
      collation[212] = new Collation(212, "utf8_german2_ci", 0, "utf8mb3");
      collation[213] = new Collation(213, "utf8_croatian_ci", 0, "utf8mb3");
      collation[214] = new Collation(214, "utf8_unicode_520_ci", 0, "utf8mb3");
      collation[215] = new Collation(215, "utf8_vietnamese_ci", 0, "utf8mb3");
      collation[223] = new Collation(223, "utf8_general_mysql500_ci", 0, "utf8mb3");
