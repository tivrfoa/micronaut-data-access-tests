...
public class ConnectionWrapper extends WrapperBase implements JdbcConnection {
      ...
      try {
         ...
         try {
            return PreparedStatementWrapper.getInstance(
               this, this.pooledConnection, this.mc.clientPrepareStatement(sql, resultSetType, resultSetConcurrency, resultSetHoldability)
            );
         } catch (SQLException var7) {
            this.checkAndFireConnectionError(var7);
            return null;
   ...
   public PreparedStatement serverPrepareStatement(String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
      try {
         ...
         try {
            return PreparedStatementWrapper.getInstance(
               this, this.pooledConnection, this.mc.serverPrepareStatement(sql, resultSetType, resultSetConcurrency, resultSetHoldability)
            );
         } catch (SQLException var7) {
            this.checkAndFireConnectionError(var7);
            return null;
            ...
            if (!"java.sql.Connection".equals(iface.getName()) && !"java.sql.Wrapper.class".equals(iface.getName())) {
               ...
               if (cachedUnwrapped == null) {
                  cachedUnwrapped = Proxy.newProxyInstance(
                     this.mc.getClass().getClassLoader(), new Class[]{iface}, new WrapperBase.ConnectionErrorFiringInvocationHandler(this.mc)
                  );
      ...
      try {
         ...
         if (isInstance) {
            ...
            return iface.getName().equals(JdbcConnection.class.getName())
               ...
               || iface.getName().equals(Connection.class.getName())
