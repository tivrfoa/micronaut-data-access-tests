...
public class FailoverConnectionProxy extends MultiHostConnectionProxy {
   ...
   private FailoverConnectionProxy(ConnectionUrl connectionUrl) throws SQLException {
      ...
      this.queriesBeforeRetryPrimaryHost = (long)((Integer)connProps.getIntegerProperty(PropertyKey.queriesBeforeRetrySource).getValue()).intValue();
      ...
      try {
         ...
         if (this.currentConnection != null) {
            StringBuilder msg = new StringBuilder("Connection to ")
               .append(this.isPrimaryHostIndex(hostIndex) ? "primary" : "secondary")
               .append(" host '")
   ...
   private int nextHost(int currHostIdx, boolean vouchForPrimaryHost) {
      ...
      if (this.isPrimaryHostIndex(nextHostIdx)
         && this.isConnected()
         && !vouchForPrimaryHost
         && this.enableFallBackToPrimaryHost
         && !this.readyToFallBackToPrimaryHost()) {
   ...
   synchronized boolean readyToFallBackToPrimaryHost() {
      return this.enableFallBackToPrimaryHost
         && this.connectedToSecondaryHost()
         && (this.secondsBeforeRetryPrimaryHostIsMet() || this.queriesBeforeRetryPrimaryHostIsMet());
   }
   ...
   public Object invokeMore(Object proxy, Method method, Object[] args) throws Throwable {
      ...
      if ("setAutoCommit".equals(methodName)) {
         this.explicitlyAutoCommit = args[0];
      }
