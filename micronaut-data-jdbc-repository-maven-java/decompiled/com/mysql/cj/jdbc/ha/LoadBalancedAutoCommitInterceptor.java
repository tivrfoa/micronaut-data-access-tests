   ...
   public <T extends Resultset> T postProcess(Supplier<String> sql, Query interceptedQuery, T originalResultSet, ServerSession serverSession) {
      try {
         if (!this.countStatements
            || StringUtils.startsWithIgnoreCase((String)sql.get(), "SET")
            || StringUtils.startsWithIgnoreCase((String)sql.get(), "SHOW")
            || StringUtils.startsWithIgnoreCase((String)sql.get(), "USE")) {
