   ...
   public InputStream getBinaryStream() throws SQLException {
      try {
         return new BufferedInputStream(
            new BlobFromLocator.LocatorInputStream(),
      ...
      LocatorInputStream(long pos, long len) throws SQLException {
         ...
         if (pos + len > blobLength) {
            throw SQLError.createSQLException(
               Messages.getString("Blob.invalidStreamLength", new Object[]{blobLength, pos, len}), "S1009", BlobFromLocator.this.exceptionInterceptor
            );
         } else if (pos < 1L) {
