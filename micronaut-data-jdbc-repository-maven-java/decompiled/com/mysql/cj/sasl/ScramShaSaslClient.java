...
public abstract class ScramShaSaslClient implements SaslClient {
   ...
   protected ScramShaSaslClient.ScramExchangeStage scramStage = ScramShaSaslClient.ScramExchangeStage.CLIENT_FIRST;
            ...
            case SERVER_FIRST_CLIENT_FINAL:
               ...
               if (serverFirstAttributes.containsKey("r") && serverFirstAttributes.containsKey("s") && serverFirstAttributes.containsKey("i")) {
                  ...
                  String clientFinalMessageWithoutProof = "c="
                     + Base64.getEncoder().encodeToString(StringUtils.getBytes(this.gs2Header, "UTF-8"))
                     + ",r="
                     + sNonce;
