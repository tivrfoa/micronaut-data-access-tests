...
public final class ScramShaSaslProvider extends Provider {
   ...
   public ScramShaSaslProvider() {
      ...
      AccessController.doPrivileged(
         () -> {
            this.putService(
               new ScramShaSaslProvider.ProviderService(this, "SaslClientFactory", "MYSQLCJ-SCRAM-SHA-1", ScramShaSaslClientFactory.class.getName())
            );
            this.putService(
               new ScramShaSaslProvider.ProviderService(this, "SaslClientFactory", "MYSQLCJ-SCRAM-SHA-256", ScramShaSaslClientFactory.class.getName())
            );
            return null;
         }
      );
