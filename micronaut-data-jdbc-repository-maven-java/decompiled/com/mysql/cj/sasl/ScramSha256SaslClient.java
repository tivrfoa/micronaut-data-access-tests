...
public class ScramSha256SaslClient extends ScramShaSaslClient {
   ...
   byte[] h(byte[] str) {
      try {
         ...
         throw ExceptionFactory.createException("Failed computing authentication hashes", var3);
      }
   }
   ...
   byte[] hmac(byte[] key, byte[] str) {
      try {
         ...
         throw ExceptionFactory.createException("Failed computing authentication hashes", var5);
      }
   }
