...
public abstract class PreparableStatement<RES_T> {
   ...
   protected PreparableStatement.PreparedState preparedState = PreparableStatement.PreparedState.UNPREPARED;
   ...
   protected void resetPrepareState() {
      ...
      } else if (this.preparedState == PreparableStatement.PreparedState.PREPARE) {
