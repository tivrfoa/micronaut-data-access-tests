...
public final class UtilityElf {
   ...
   public static <T> T createInstance(String className, Class<T> clazz, Object... args) {
      if (className == null) {
         ...
         try {
            ...
            if (args.length == 0) {
               return (T)clazz.cast(loaded.getDeclaredConstructor().newInstance());
            } else {
               ...
               return (T)clazz.cast(constructor.newInstance(args));
            }
   ...
   public static ThreadPoolExecutor createThreadPoolExecutor(
      BlockingQueue<Runnable> queue, String threadName, ThreadFactory threadFactory, RejectedExecutionHandler policy
   ) {
      if (threadFactory == null) {
         threadFactory = new UtilityElf.DefaultThreadFactory(threadName, true);
      }
