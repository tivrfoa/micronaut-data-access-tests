...
final class SchemaUtil {
   ...
   static int computeSizeMessage(int fieldNumber, Object value, Schema schema) {
      return value instanceof LazyFieldLite
         ? CodedOutputStream.computeLazyFieldSize(fieldNumber, (LazyFieldLite)value)
         : CodedOutputStream.computeMessageSize(fieldNumber, (MessageLite)value, schema);
   }
   ...
   static <UT, UB> UB filterUnknownEnumList(
      int number, List<Integer> enumList, Internal.EnumLiteMap<?> enumMap, UB unknownFields, UnknownFieldSchema<UT, UB> unknownFieldSchema
   ) {
      if (enumMap == null) {
   ...
   static <UT, UB> UB filterUnknownEnumList(
      int number, List<Integer> enumList, Internal.EnumVerifier enumVerifier, UB unknownFields, UnknownFieldSchema<UT, UB> unknownFieldSchema
   ) {
