...
abstract class BinaryReader implements Reader {
   ...
   private static final class SafeHeapReader extends BinaryReader {
      ...
      private long readLittleEndian64_NoCheck() {
         ...
         byte[] buffer = this.buffer;
         this.pos = p + 8;
         return (long)buffer[p] & 255L
            | ((long)buffer[p + 1] & 255L) << 8
            | ((long)buffer[p + 2] & 255L) << 16
            | ((long)buffer[p + 3] & 255L) << 24
            | ((long)buffer[p + 4] & 255L) << 32
            | ((long)buffer[p + 5] & 255L) << 40
            | ((long)buffer[p + 6] & 255L) << 48
            | ((long)buffer[p + 7] & 255L) << 56;
      }
