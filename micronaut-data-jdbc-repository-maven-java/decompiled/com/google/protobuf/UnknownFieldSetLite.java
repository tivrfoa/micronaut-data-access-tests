   ...
   public void writeTo(CodedOutputStream output) throws IOException {
      for(int i = 0; i < this.count; ++i) {
         ...
         switch(WireFormat.getTagWireType(tag)) {
            case 0:
               output.writeUInt64(fieldNumber, this.objects[i]);
               break;
            case 1:
               output.writeFixed64(fieldNumber, this.objects[i]);
               break;
            case 2:
            ...
            case 5:
               output.writeFixed32(fieldNumber, this.objects[i]);
         }
      }
   ...
   public int getSerializedSize() {
      ...
      if (size != -1) {
         ...
         for(int i = 0; i < this.count; ++i) {
            ...
            switch(WireFormat.getTagWireType(tag)) {
               case 0:
                  size += CodedOutputStream.computeUInt64Size(fieldNumber, this.objects[i]);
                  break;
               case 1:
                  size += CodedOutputStream.computeFixed64Size(fieldNumber, this.objects[i]);
                  break;
               case 2:
               ...
               case 5:
                  size += CodedOutputStream.computeFixed32Size(fieldNumber, this.objects[i]);
            }
         }
